...
/Users/natpacket/Desktop/ios-reverse/sh/appSign.sh
...
rm -fr "$TARGET_APP_PATH/com.apple.WatchPlaceholder"


#---------------------------------------------
# 4. 更新info.list文件 CFBundleIdentifier  这里可能需要自己根据app进行调整
# 设置:" Set : Key Value" "目标文件路径"
newBundleDisplayName="WeChat"

/usr/libexec/PlistBuddy -c "Set :CFBundleDisplayName $newBundleDisplayName" "$TARGET_APP_PATH/Info.plist"
