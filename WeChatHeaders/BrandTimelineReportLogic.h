...
@class BTLNotifyBarReportItem, BTLTopBarReportItem, BrandReportMainSessionInfo, BrandTLExptConfig, NSMutableArray, NSMutableDictionary, NSMutableSet;
...
- (id)genComExposeInfoForRecCanvasSection:(id)arg1;
