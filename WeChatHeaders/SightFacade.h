...
- (_Bool)isSightPreviewMarginTop0:(unsigned long long)arg1;
...
- (_Bool)checkSWTranscodingChange:(id)arg1 InputViodeoPrams:(struct WxVideoTransParaABA)arg2 OutViodeoPrams:(struct WxVideoTransParaABA)arg3 scene:(unsigned long long)arg4;
...
- (void)initABAReportPrams:(id)arg1 wxABAPrams:(struct WxAdaptiveBRResParams)arg2 outPara:(struct WxVideoTransParaABA)arg3;
...
- (void)exportVideoWithCompressByAsset:(id)arg1 assetURL:(id)arg2 scene:(unsigned long long)arg3 isSlowMotion:(_Bool)arg4 withCompletion:(CDUnknownBlockType)arg5 andPathPrefix:(id)arg6 encodeJson:(id)arg7 extraInfo:(id)arg8;
