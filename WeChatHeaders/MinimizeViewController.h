...
@interface MinimizeViewController : MMUIViewController <MinimizeDraggableTaskViewDelegate, MinimizeTaskStateViewDelegate, WCActionSheetDelegate, CAAnimationDelegate, MinimizeTaskOuterContentViewDelegate, MinimizeBaseViewDelegate, MMInputToolViewExt, MinimizeAbsorbFloatingViewDelegate>
{
    _Bool _isAnimating;
...
- (void)animateHideRecFloatingView:(id)arg1;
