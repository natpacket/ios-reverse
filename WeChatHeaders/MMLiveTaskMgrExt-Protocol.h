...
@class CBaseContact, LiveSdkInfo, MMFinderLiveConnectMicUsersInfo, MMLiveAnchorStatusItem, MMLiveSEIConnectMicMsg, MMLiveTask, MMLiveTaskId, MMMetricsInfo, NSArray, NSDictionary, NSError, NSString, TRTCQualityInfo, TRTCStatistics;
...
- (void)onFinderShopLiveUpdateCommodityInStockCount:(unsigned long long)arg1 appId:(NSString *)arg2 finderUsername:(NSString *)arg3;
...
- (void)onMMLiveCancel;
- (void)onExitLiveSuccessWithLiveTask:(MMLiveTaskId *)arg1;
