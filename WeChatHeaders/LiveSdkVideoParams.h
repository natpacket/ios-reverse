...
@property(retain, nonatomic) VideoPKParams *micAllGrid9; // @dynamic micAllGrid9;
@property(retain, nonatomic) VideoPKParams *micAnchor11; // @dynamic micAnchor11;
@property(retain, nonatomic) VideoPKParams *micAudience11; // @dynamic micAudience11;
@property(retain, nonatomic) VideoPKParams *micAudience12; // @dynamic micAudience12;
