...
#import "IWCPayPluginTopMsgMgrExt-Protocol.h"
...
@class ChatUnavailableTipsView, MMInputToolView, NSString, OpenIMSucceedContactLogic, UIImageView, WCTopicSearchViewController, XMailBindMailControlLogic;
