...
- (void)updateViewWithLogoSVGImage:(id)arg1 headContact:(id)arg2 headTitle:(id)arg3 headContent:(id)arg4 numberOfLines:(unsigned long long)arg5 logoLightIconUrl:(id)arg6 logoDarkIconUrl:(id)arg7;
