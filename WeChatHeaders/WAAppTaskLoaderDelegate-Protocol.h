...
@class NSArray, NSDictionary, NSMutableArray, NSString, UIViewController, WACacheVersionPreCheckerContextResult, WAContact, WAPackageConfig, WAUINavigationController, WAWebViewController;
