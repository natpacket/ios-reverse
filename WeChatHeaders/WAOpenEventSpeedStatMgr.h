...
- (void)reportInitReadyWithUsername:(id)arg1 appid:(id)arg2 appType:(unsigned int)arg3 path:(id)arg4 isPreload:(unsigned int)arg5 splashADState:(unsigned int)arg6 canShowLoadingAdvert:(_Bool)arg7 isSkyline:(_Bool)arg8 useRenderingCache:(_Bool)arg9;
...
- (void)reportTaskClosedWith:(id)arg1 username:(id)arg2 task:(id)arg3 reason:(unsigned long long)arg4;
