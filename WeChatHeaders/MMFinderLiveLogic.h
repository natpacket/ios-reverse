...
#import "MMFinderLiveFansGroupInfoExt-Protocol.h"
...
@class MMFinderLiveConnectMicLogic, MMFinderLiveImageOcrOp, MMFinderLiveOperationViewModel, MMFinderLiveRedPacketLogic, MMFinderLiveRedPacketMessage, MMFinderLiveTask, MMFinderLiveTaskId, MMLiveScreenSharingLogic, NSString, WCFinderLiveInfo, WeAvatarLogic;
@protocol MMFinderLiveLogicDelegate;

@interface MMFinderLiveLogic : MMLiveLogic <WCFinderContactExt, MMFinderLiveFansGroupInfoExt, MMFinderLiveConnectMicActionDelegate, MMFinderLiveRedPacketLogicDelegate, MMLiveCommentViewDelegate, MMLiveScreenSharingLogicOperationDelegate, MMLiveScreenSharingLogicUIDelegate, WCFinderLiveExt>
{
    _Bool _isLiveClosed;
...
- (void)onGetHandledFinderLiveMessage:(id)arg1 taskId:(id)arg2 onlineContacts:(id)arg3 msgList:(id)arg4 finderLiveInfo:(id)arg5 onlineCount:(unsigned int)arg6 liveInfoEnable:(_Bool)arg7 liveClosed:(_Bool)arg8 onlineViewCount:(unsigned int)arg9 respContext:(id)arg10;
...
- (void)onGetFinderLiveApplyMicMessageWithTaskId:(id)arg1 fromFinderContact:(id)arg2 withVideo:(_Bool)arg3 seatId:(unsigned int)arg4 confirmTime:(unsigned int)arg5 sdkUserId:(id)arg6 sessionId:(id)arg7 micUserAttrFlag:(unsigned int)arg8;
...
- (void)checkLiveMicAnchorBattleInfoInJoinLiveResponse:(id)arg1 micSessionId:(id)arg2;
...
- (void)onCreateFinderLiveError:(id)arg1 finderDataItem:(id)arg2 errorPage:(id)arg3 warnPage:(id)arg4 isMiniGameLive:(_Bool)arg5;
