...
#import "WAWebGLCanvasDelegate-Protocol.h"

@class NSString, UIView;
@protocol TXLivePushJSAdapterProtocol;

@interface WAWebViewPlugin_LivePusher : WAWebViewPlugin_embedView <TXLivePushJSAdapterDelegate, WAWebGLCanvasDelegate>
{
