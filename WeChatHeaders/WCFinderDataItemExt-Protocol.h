...
@class FinderOriginalDesc, FinderPlayHistoryInfo, NSArray, NSString, OriginalSoundInfo, WCFinderAdEntryItem, WCFinderComment, WCFinderDataItem, WCFinderJumpInfoContainer, WCFinderUploadProgressModel;
...
- (void)onFinderDataItemWithTid:(NSString *)arg1 jumpInfoContainerChanged:(WCFinderJumpInfoContainer *)arg2 commentScene:(unsigned long long)arg3 noExposeReport:(_Bool)arg4;
- (void)onFinderDataItemWithTid:(NSString *)arg1 jumpInfoContainerChanged:(WCFinderJumpInfoContainer *)arg2 commentScene:(unsigned long long)arg3;
