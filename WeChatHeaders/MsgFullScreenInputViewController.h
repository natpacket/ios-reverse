...
@interface MsgFullScreenInputViewController : MMUIViewController <EmoticonBoardViewDelegate, BaseEmoticonViewDelegate, textViewDelegate, UIGestureRecognizerDelegate, UITextViewDelegate>
{
