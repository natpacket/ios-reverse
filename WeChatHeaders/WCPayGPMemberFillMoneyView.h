...
@class CContact, MMTableView, MMUIButton, MMUILabel, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, UIImageView, UITextField, WCPayGPMemberFillMoneyCell;
