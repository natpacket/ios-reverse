...
@class NSString, RichTextView, WCSNSMessage, WCUserComment;
@protocol WCCommentListContentViewDelegate;

@interface WCCommentListContentView : UIView <WCImageViewDelegate, ILinkEventExt, WCCommentEmotionViewDelegate>
{
