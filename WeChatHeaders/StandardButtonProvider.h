...
+ (id)genWeakButton:(long long)arg1 maxWidth:(double)arg2 inverse:(_Bool)arg3;
+ (id)genCustomizedStrongButton:(id)arg1;
...
+ (id)genRedesignButtonWithColor:(id)arg1 fontColor:(id)arg2;
