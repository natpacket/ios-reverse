...
@class FinderJumpInfo_Style, NSString, NSURL, UIButton, UIView, WCFinderBulletItem, WCFinderComment, WCFinderCommonBottomBannerView, WCFinderContact, WCFinderDataItem, WCFinderFeedContentVM, WCFinderFeedMediaWrap, WCFinderFeedStreamLiveCellRouterModel, WCFinderFullMultiMediaTableViewCell, WCFinderJumpInfo, WCFinderNpsSurveyContextInfo, WCFinderPlayerReport;
...
- (void)onFeedCellClickPostComment:(NSString *)arg1 scene:(long long)arg2 contentVM:(WCFinderFeedContentVM *)arg3;
...
- (WCFinderNpsSurveyContextInfo *)getFinderSurveyContextInfoForCell:(WCFinderFullMultiMediaTableViewCell *)arg1;
- (void)onLongPressShowSimpleMenu:(WCFinderFeedContentVM *)arg1;
