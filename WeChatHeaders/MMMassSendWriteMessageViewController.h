...
@interface MMMassSendWriteMessageViewController : MMUIViewController <AudioRecorderEventExt, MMInputToolViewDelegate, UITableViewDelegate, UITableViewDataSource, MMTableViewDelegate, ImageControllerDelegate, IMsgExt, IMassSendExt, RecordControllerDelegate, WCActionSheetDelegate, StreamVoiceInputViewControllerDelegate>
{
