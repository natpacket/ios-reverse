...
@interface WCCommentDetailRootCommentCell : WCCommentDetailCell <WCFinderFeedContentTextClickActionDelegate, ILinkEventExt, WCFinderHeadImageViewDelegate, WCFinderContactExt>
{
