...
@class NSMutableDictionary, NSString, OrderedDictionary, TRTCDecoderFactory;
...
- (void)preloadLiveRoomCDNPlayerItemWithId:(id)arg1 url:(id)arg2 originalUrl:(id)arg3 andDelayStopTime:(double)arg4 liveSdkInfo:(id)arg5 liveVrType:(unsigned int)arg6 anchorNickname:(id)arg7;
