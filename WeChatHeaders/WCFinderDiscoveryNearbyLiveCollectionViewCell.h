...
@class MMFinderLiveActivityView, MMLiveCDNPlayerView, NSString, RichTextView, UIImageView, UILabel, UIView, WCFinderAuthInfoIconView, WCFinderDiscoveryNearbyLiveCollectionViewCellConfig, WCFinderFeedContentVM, WCFinderHeadImageView;
@protocol WCFinderDiscoveryNearbyLiveCollectionViewCellDelegate;

@interface WCFinderDiscoveryNearbyLiveCollectionViewCell : UICollectionViewCell <WCFinderFeedContentVMExt, MMLiveCDNPlayerViewDelegate, ILinkEventExt, WCFinderMoreLiveCellPlayProtocol>
{
    _Bool _hiddenVideo;
