...
@interface WCFinderPostFullScreenPreviewViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource, WCFinderFeedContentVMExt, WCFinderFullMultiMediaTableViewCellDelegate, WCFinderFeedBaseViewControllerProtocol, MMScrollActionSheetDelegate, WCActionSheetDelegate, WCFinderCardWebViewControllerDelegate, RingBackInfoDisplaySheetViewDelegate, WCGeneralMonitorDelegate>
{
