...
@class CContact, NSDictionary, NSString, WCAdCanvasLoadParams;
...
- (void)onCanvasDynamicXMLReturn:(NSString *)arg1 error:(int)arg2 forCanvasLoadParams:(WCAdCanvasLoadParams *)arg3;
