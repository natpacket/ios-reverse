...
@class FinderLiveCoverInfo, FinderLiveInfo, FinderLiveNoticeInfo, FinderPlayHistoryInfo, NSMutableArray, NSString, WCFinderDataItem, WCFinderFeedContentVM;
...
- (void)onFeedContentJumpInfoContainerChanged:(WCFinderFeedContentVM *)arg1 isPureUIChanged:(_Bool)arg2 showPosition:(long long)arg3 scene:(unsigned long long)arg4 disableReport:(_Bool)arg5;
- (void)onFeedContentJumpInfoContainerChanged:(WCFinderFeedContentVM *)arg1 isPureUIChanged:(_Bool)arg2 showPosition:(long long)arg3 scene:(unsigned long long)arg4;
...
- (void)onFeedContent:(WCFinderFeedContentVM *)arg1 afterLikedDataUpdateByUserAction:(NSString *)arg2 likeFlag:(long long)arg3 touchPoint:(struct CGPoint)arg4;
