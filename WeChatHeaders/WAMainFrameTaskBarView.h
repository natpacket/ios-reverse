...
#import "WAMainFrameAudioCenterCellDelegate-Protocol.h"
...
#import "WAMainFrameTaskBarSectionWeAppContainerDelegate-Protocol.h"
#import "WAMainFrameTaskBarSectionWeAppViewDelegate-Protocol.h"
#import "WCMainWindowExt-Protocol.h"

@class CADisplayLink, CAGradientLayer, DynamicBackgroundSystemConfig, MFTitleView, MMUIViewController, NSMutableArray, NSString, NewMainFrameRightTopMenuBtn, UIBarButtonItem, UIButton, UICollectionView, UIImageView, UILabel, UISearchBar, WADynamicBackgroundGLViewController, WAMainFrameAudioCenterCell, WAMainFrameDesktopContainerView, WAMainFrameTaskBarCloseArea, WAMainFrameTaskBarDotLoadingView, WAMainFrameTaskBarLogic, WAMainFrameTaskBarSectionMyWeAppView, WAMainFrameTaskBarSectionWeAppContainerView, WAMainFrameTaskBarSectionWeAppView, WATaskBarCollectionViewLayout;
@protocol WAMainFrameTaskBarViewDelegate;

@interface WAMainFrameTaskBarView : UIView <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, WADynamicBackgroundGLViewControllerDelegate, WAMainFrameTaskBarSectionWeAppViewDelegate, WAMainFrameTaskBarSectionBaseViewReportDelegate, WAMainFrameTaskBarSectionWeAppContainerDelegate, WAMainFrameTaskBarSectionOtherViewDelegate, WAMainFrameAudioCenterCellDelegate, IUiUtilExt, UIGestureRecognizerDelegate, WAMainFrameDesktopContainerViewDelegate, WCMainWindowExt, MMLimitedModeExt, WAMainFrameTaskBarSectionSearchViewDelegate, MiniTaskUIMgrExt>
{
    ...
    WAMainFrameAudioCenterCell *_audioCell;
...
- (void).cxx_destruct;
@property(retain, nonatomic) WAMainFrameAudioCenterCell *audioCell; // @synthesize audioCell=_audioCell;
