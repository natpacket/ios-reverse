...
@class MMListenDiscoverLine, MMUIActivityIndicatorView, NSData, NSMutableSet, NSString, TingFooterView;

@interface TingPlayListsViewController : ICCollectionViewController <TingViewController>
{
    ...
    NSMutableSet *_setTapeIds;
}

+ (id)tapeInfoFromDiscoverItem:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableSet *setTapeIds; // @synthesize setTapeIds=_setTapeIds;
