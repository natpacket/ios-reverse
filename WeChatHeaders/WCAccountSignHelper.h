...
@interface WCAccountSignHelper : NSObject
{
    ...
    basic_string_0ec669f3 _privateKeyForECDSA;
}
...
@property(nonatomic) basic_string_0ec669f3 privateKeyForECDSA; // @synthesize privateKeyForECDSA=_privateKeyForECDSA;
