...
@interface FaceRecogBaseHandler : MMObject <MonoServiceLogicExt, ISysCallCheckExt, ILocationMgrExt, LocationRetrieveDelegate, IRecordPermissionCheckExt, FaceRecogUploadLogicDelegate, FaceRecogConfigLogicDelegate, FaceRecogBaseHandlerDelegate, FaceRecogBaseViewDelegate>
{
    _Bool _needGuide;
