...
@class CContact, CContactVerifyLogic, CMessageWrap, MMTableViewInfo, MMTextView, MMUILabel, MMUITextField, NSArray, NSDate, NSMutableArray, NSMutableSet, NSString, SendVerifyMsgLogicController, UIButton, UIView, WCTableViewNormalCellManager;
@protocol SendVerifyMsgViewControllerDelegate;

@interface SendVerifyMsgViewController : MMUIViewController <MMTableViewInfoDelegate, ILinkEventExt, UITextViewDelegate, IContactTagViewControllerExt, NewContactTagViewControllerDelegate, MMUIViewControllerExt, UITextFieldDelegate, contactVerifyLogicDelegate>
{
