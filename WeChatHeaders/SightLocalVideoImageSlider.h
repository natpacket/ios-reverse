...
- (void)asyncUpdateStartTime:(double)arg1 endTime:(double)arg2 andStartPlayFlagAnim:(_Bool)arg3 withCompletion:(CDUnknownBlockType)arg4;
...
- (double)getStartFlagWidth;
- (struct CGRect)validFrameOfMaskView;
- (void)updateMaskViewDuration:(double)arg1;
- (void)setDefaultSlider:(double)arg1 defaultImage:(id)arg2 completion:(CDUnknownBlockType)arg3;
