...
@interface WCFinderContactPreviewData : NSObject <PBCoding, WCTColumnCoding>
{
    ...
    FinderObjectMutalbeArray *_dataItems;
    unsigned long long _expectNextFetchTimestamp;
    FinderObjectMutalbeArray *_likeListDataItem;
}
...
- (void).cxx_destruct;
@property(retain, nonatomic) FinderObjectMutalbeArray *likeListDataItem; // @synthesize likeListDataItem=_likeListDataItem;
...
@property(retain, nonatomic) FinderObjectMutalbeArray *dataItems; // @synthesize dataItems=_dataItems;
