...
@class MMUIButton, NSString, RichTextView, UICollectionReusableView, UICollectionView, UICollectionViewFlowLayout, UILabel, UITapGestureRecognizer, WCFinderAnimationLoadingView, WCFinderFeedContentVM, WCFinderFeedLikeListViewModel, WCFinderLikeInfo, WCFinderStreamFooterView;

@interface WCFinderFeedLikeListViewController : MMUIHalfScreenViewController <UICollectionViewDataSource, UICollectionViewDelegate, WCFinderStreamFooterViewActionDelegate, WCFinderFeedLikeListViewModelDelegate, UICollectionViewDelegateFlowLayout, WCFinderFansProfileViewControllerDelegate, WCFinderHalfScreenProtocol>
{
