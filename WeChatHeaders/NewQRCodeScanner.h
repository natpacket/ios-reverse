...
@interface NewQRCodeScanner : MMUIView <UINavigationControllerDelegate, CameraScannerViewDelegate, IUiUtilExt>
{
    ...
    char *_sendImage;
    basic_string_0ec669f3 _decodeData;
    basic_string_0ec669f3 _decodeType;
    basic_string_0ec669f3 _decodeCharset;
...
@property(nonatomic) basic_string_0ec669f3 decodeData; // @synthesize decodeData=_decodeData;
