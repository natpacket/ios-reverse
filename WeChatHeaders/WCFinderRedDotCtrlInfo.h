...
+ (void)PBArrayAdd_reportCtrlInfo;
...
@property(nonatomic) long long saveStrategy; // @synthesize saveStrategy=_saveStrategy;
...
@property(copy, nonatomic) NSData *reportCtrlInfo; // @synthesize reportCtrlInfo=_reportCtrlInfo;
