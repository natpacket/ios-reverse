...
@class NSString, UnifyAuthResponse, WCAccountGraphicVerifyControlLogic;
@protocol WCAccountManualAuthControlLogicDelegate;

@interface WCAccountManualAuthControlLogic : WCAccountBaseControlLogic <MMWebViewDelegate, WCAccountGraphicVerifyControlLogicDelegate, PBMessageObserverDelegate>
{
