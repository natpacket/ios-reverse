...
#import "WCFinderInteractionThanksExt-Protocol.h"
...
@interface WCFinderNotifyCenterCellViewModel : NSObject <WCFinderPrivateAccountExt, WCFinderInteractionThanksExt>
{
    _Bool _isAuthor;
    _Bool _isFinder;
...
- (void)onFinderInteractionThanksStateChangedWithMention:(id)arg1;
