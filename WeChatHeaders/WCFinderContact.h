...
@class AchievementInfo, FinderBizInfo, FinderContact, FinderContactClubInfo, FinderContactLiveInfo, FinderContactMsgInfo, FinderGuestInfo, FinderLiveNoticeInfo, FinderSticker, FinderWecomInfo, NSString, WCFinderAuthInfo, WCFinderBindInfoList, WCFinderContactExtInfo, WCFinderContactServiceMenuMutableArray, WCFinderDataItem, WCFinderJumpInfo;
...
@interface WCFinderContact : NSObject <WCTColumnCoding, PBCoding, WCFinderLiveExt, WCTTableCoding>
{
    ...
    NSString *_coverUrl;
    long long _coverEntraceFlag;
    unsigned long long _attrStatus;
    WCFinderDataItem *_livingDataItem;
    unsigned long long _userType;
    unsigned long long _additionalFlag;
...
@property(nonatomic) unsigned long long additionalFlag; // @synthesize additionalFlag=_additionalFlag;
...
@property(nonatomic) unsigned long long attrStatus; // @synthesize attrStatus=_attrStatus;
@property(nonatomic) long long coverEntraceFlag; // @synthesize coverEntraceFlag=_coverEntraceFlag;
