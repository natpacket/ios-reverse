...
#import "MMFinderLiveConcertTicketViewControllerDelegate-Protocol.h"
...
@interface MMFinderLiveConcertTicketContainerViewController : MMUIViewController <MMFinderLiveConcertTicketViewControllerDelegate>
{
...
- (void)dealloc;
- (id)initWithActivityId:(id)arg1 objectId:(unsigned long long)arg2 liveId:(unsigned long long)arg3 anchorDisplayName:(id)arg4 ticketReceivingScene:(unsigned int)arg5 sourceScene:(unsigned long long)arg6 reportingContext:(id)arg7;
- (id)initWithLiveNoticeId:(id)arg1 activityId:(id)arg2 anchorDisplayName:(id)arg3 sourceScene:(unsigned long long)arg4 reportingContext:(id)arg5;
- (id)initWithLiveTaskId:(id)arg1 anchorDisplayName:(id)arg2 sourceScene:(unsigned long long)arg3 reportingContext:(id)arg4;
