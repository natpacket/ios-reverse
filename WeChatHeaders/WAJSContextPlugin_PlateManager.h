...
@interface WAJSContextPlugin_PlateManager : WAJSContextPluginBase <PBMessageObserverDelegate, WAPlateAuthorizePageSheetDelegate, WAPlateManageViewControllerDelegate, UIViewControllerTransitioningDelegate, WAPopInteractiveTransitionDelegate>
{
