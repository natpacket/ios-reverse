...
@interface WCFinderOpenTimelineParams : NSObject
{
    ...
    unsigned long long _failReturnTo;
...
@property(nonatomic) unsigned long long failReturnTo; // @synthesize failReturnTo=_failReturnTo;
...
- (id)initFromSnsTimlineWithPostSession:(id)arg1;
- (id)initFromFindPageClick;
- (id)initFromPushWithFromVC:(id)arg1 shouldReloadTableView:(_Bool)arg2 forceJumpTabType:(unsigned long long)arg3 topObjects:(id)arg4 commByPass:(id)arg5 demotionFlag:(unsigned long long)arg6 failReturnTo:(unsigned long long)arg7 taskID:(id)arg8 pushLevel:(unsigned long long)arg9 jumpInfo:(id)arg10;
...
- (id)initFromTingMusicWithPostSession:(id)arg1;
