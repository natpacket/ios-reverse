...
@class BaseResponse, FinderBizUserInfo, FinderJoinLiveResp_FlashSaleInfo, FinderJoinLiveResp_PromotingInfo, FinderJoinLiveTips, FinderJumpInfo, FinderLiveAdInfo, FinderLiveAudienceEventInfo, FinderLiveBackgroundMusicInfo, FinderLiveBulletin, FinderLiveCheerInfo, FinderLiveContact, FinderLiveErrorPage, FinderLiveExtFlag, FinderLiveFanClubInfo, FinderLiveGameData, FinderLiveGameInfo, FinderLiveGamePlayTogether, FinderLiveHotCommentAnimationInfoList, FinderLiveInfo, FinderLiveInternalPageInfo, FinderLiveMandatoryReplaceInfo, FinderLiveMicInfo, FinderLivePackageExtInfo, FinderLivePromoteExtInfo, FinderLivePromoteMsgInfo, FinderLiveRecommendPreloadInfo, FinderLiveResourcePreloadInfo, FinderLiveRewardQuotaSwitchInfo, FinderLiveRoleAndPermissionList, FinderLiveShopWindowProductItem, FinderLiveStreamDecor, FinderLiveUserInfo, FinderLocation, FinderWxAppInfo, GameLiveJumpInfo, GameRankSwitchInfo, GeneralGameLiveInfo, JoinLiveInvisiableSwitchInfo, LiveRoomImg, LiveSdkInfo, LiveWeappJumpInfo, NSData, NSMutableArray, NSString, SongListInfo;
