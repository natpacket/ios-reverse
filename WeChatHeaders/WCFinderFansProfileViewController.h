...
@class CContact, FinderContactExtRelationInfo, NSString, RichTextView, UIButton, UILabel, UIScrollView, WCFinderComment, WCFinderContact, WCFinderHalfProfileInfoView, WCFinderHeadImageView;
...
- (void)updateContact:(id)arg1 svrMentionId:(unsigned long long)arg2;
