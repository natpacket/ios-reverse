...
@class AVAudioPlayer, AVVideoDevice, MMTimer, MMViewCapture, MinimizeTaskData, MultiTalkMainViewController, MultiTalkWindow, MultitalkMinimizeView, NSMutableArray, NSMutableDictionary, NSRecursiveLock, NSString, RingBackSoundCoordinator, SafeMutableDictionary, VoipCheckAudioDeviceObj;

@interface MultiTalkMgr : MMUserService <MMKernelExt, MultitalkApiDelegate, WXCMultiTalkApiDelegate, WXCAssistHelperDelegate, MultiTalkCgiDelegate, IMsgExt, MultiTalkMainViewControllerDelegate, AVVideoDeviceSessionDelegate, AVVideoDeviceDelegate, AVVideoDataSource, MMViewCaptureDelegate, CNetworkStatusExt, MonoServiceMsgLogicDelegate, MonoServiceMsgDelegate, VoIPPushKitExt, IGroupMgrExt, IContactMgrExt, IMinimizeTaskDelegateInterface, PBMessageObserverDelegate, WCAudioModuleDelegate, MMServiceProtocol>
{
    char *cameraBuf;
    int cameraBufSize;
...
- (int)ilinkDoCreateMultiTalk:(id)arg1;
...
- (unsigned int)getNextEnableTimeForOpenCamera;
