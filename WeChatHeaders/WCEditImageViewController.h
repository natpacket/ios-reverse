...
@class EditImageAttr, EditVideoBGMSelectedMusicInfo, MMAsset, NSMutableArray, NSString, RecommendedMusicInfo, UIImage, UIView, WCEditImageLayoutView, WCEditViewControllerUIConfig;
