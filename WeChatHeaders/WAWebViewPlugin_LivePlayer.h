...
@interface WAWebViewPlugin_LivePlayer : WAWebViewPlugin_embedView <TXLivePlayJSAdapterDelegate, WAMediaCastingAirPlayDetectorDelegate, IWAWebViewPlugin_LivePlayer>
{
