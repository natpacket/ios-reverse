...
@interface MMFinderLivePaymentSettingViewController : MMUIViewController <MMFinderLivePaymentSettingViewDelegate, SessionSelectControllerDelegate, MMCommonActionSheetPickerDelegate, WCFinderLiveRosterSelectDelegate, MMFinderLivePaymentTrialModeSettingViewDelegate, MMFinderLivePaymentPolicyIntroViewDelegate>
{
