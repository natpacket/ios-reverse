...
- (id)createWebviewCtrlMayApplyFastLoad:(id)arg1 mpFastLoadParam:(id)arg2 scene:(unsigned int)arg3 visibleViewController:(id)arg4 addExtraInfo:(id)arg5 presetUI:(id)arg6 isUsedFastLoad:(_Bool *)arg7 forceUrl:(id *)arg8 canKaraHandle:(_Bool)arg9 useOfflineCache:(_Bool)arg10;
