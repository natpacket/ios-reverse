...
+ (void)ReportDesignerEmojiTipsWithScene:(unsigned int)arg1 action:(unsigned long long)arg2 Md5:(id)arg3 searchId:(unsigned long long)arg4 designerId:(id)arg5 pid:(id)arg6 sessionId:(id)arg7 emoticonScene:(long long)arg8;
...
+ (void)ReportEmoticonBrowsePageExposure:(id)arg1 activityID:(id)arg2 pid:(id)arg3 designerUin:(id)arg4 newPage:(long long)arg5 sessionID:(id)arg6 lensID:(id)arg7 linkId:(id)arg8 linkExposured:(_Bool)arg9 linkClicked:(_Bool)arg10 weappClicked:(_Bool)arg11;
