...
@interface MMLivePriorityQueue : NSObject
{
    _Bool _noPriority;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool noPriority; // @synthesize noPriority=_noPriority;
...
- (_Bool)isEmpty;
- (id)initWithCapacity:(int)arg1 maxSize:(unsigned int)arg2;
