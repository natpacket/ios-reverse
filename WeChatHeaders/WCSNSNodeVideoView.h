...
#import "WCMomentsPlayerSourceControllerDataSource-Protocol.h"
#import "WCMomentsPlayerSourceControllerDelegate-Protocol.h"
...
- (id)getPlayerInfoWithMuted:(_Bool)arg1 isFullScreen:(_Bool)arg2;
