...
- (void)searchOpenIMContactForThirdWithDic:(id)arg1 scene:(unsigned int)arg2 spamContext:(id)arg3 extInfo:(id)arg4;
- (void)searchOpenIMContactForThird:(id)arg1 scene:(unsigned int)arg2 spamContext:(id)arg3 extInfo:(id)arg4;
