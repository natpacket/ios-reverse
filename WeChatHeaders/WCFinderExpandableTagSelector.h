...
@class NSArray, NSDictionary, NSMutableDictionary, NSMutableSet, NSString, UICollectionView, UIColor, UIFont, WCFinderExpandableTagSelectorExpandInfo;
...
@property(retain, nonatomic) NSArray *rootViews; // @synthesize rootViews=_rootViews;
