...
@interface AddContactToChatRoomViewController : MMUIViewController <WCActionSheetDelegate, IStrongNotificationMgrExt, MsgSearchHelperDelegate, ChatRoomMemberGridViewDelegate, IContactMgrExt, CreateChatLogicDelegate, contactInfoDelegate, IntelligentMsgBrowseResultCommonDelegate>
{
    CContact *m_contact;
