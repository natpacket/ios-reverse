...
@interface TextStateSubCommentTableViewCell : TextStateBaseCommentCell <WCFinderFeedContentTextClickActionDelegate, WCFinderHeadImageViewDelegate, WCFinderContactExt>
{
