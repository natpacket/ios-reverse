...
#import "WCMomentsContactTagEditViewDelegate-Protocol.h"
#import "WCMomentsContactTagSearchViewControllerDelegate-Protocol.h"

@class MMTableView, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSString, UILabel, WCMomentsContactTagEditView, WCSearchBar;
@protocol WCMomentsContactTagListViewControllerDelegate;

@interface WCMomentsContactTagListViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource, ContactTagNewDetailViewControllerDelegate, WCMomentsContactTagEditViewDelegate, WCMomentsContactTagSearchViewControllerDelegate>
{
...
- (void)searchViewController:(id)arg1 didSelectTagDataSet:(id)arg2;
