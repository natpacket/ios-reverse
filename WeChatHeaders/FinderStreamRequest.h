...
@class BaseRequest, FinderBaseRequest, FinderClientStatus, FinderCommByPass, FinderLiveBeforeJoinLiveRoomStatus, FinderLiveClientStatus, FinderStreamRelatedInfo, FinderStreamSceneStatus, FinderSubTabItem, FinderSwitch, NSData, NSMutableArray, NSString;
