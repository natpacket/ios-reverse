...
@class AnnotationLogicController, CAShapeLayer, MMFloorPickView, MMLoadingView, MMMapView, MMTimer, NSString, NavigateLogicController, POIInfo, TrackRoomTopBarView, UIButton, UIView, WCUIAlertView;
@protocol TrackRoomViewDelegate;

@interface TrackRoomView : MMUIWindow <ITrackRoomMgrExt, TrackRoomTopBarViewDelegate, QMapViewDelegate, QMapViewIndoorDelegate, WCActionSheetDelegate, ILocationMgrExt, IWXTalkieExt, IAUAudioDeviceExt, UIGestureRecognizerDelegate, NavigateLogicControllerDelegate, IShortCutExt, IRecordPermissionCheckExt>
{
