...
@interface MMVideoPreviewBrowserView : MMUIScrollView <IMMAssetICloudExt, SightAssetPreviewViewDelegate, FullScreenGestureDelegate, WCAudioModuleDelegate, MMAssetPickerBrowserViewProtocol>
{
    NSURL *m_originUrl;
    AVAsset *m_avAsset;
