...
@class DataCenterConfig, FinderNewUserPrepareResponse, NSString, WCFinderContact, WCFinderPersonalSettingParams, WCTableViewManager;

@interface WCFinderPrimarySettingViewController : MMUIViewController <WCFinderContactExt, WCFinderUserPrepareCgiDelegate, WCFinderFeedBaseViewControllerProtocol>
{
...
- (void)addShowInWXProfileSection:(id)arg1;
