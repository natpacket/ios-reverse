...
@class NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSRecursiveLock, NSString, UIImage, WSRecommendColikeStorage, WSRecommendColikeTempModel, WSRecommendSetting, _TtC6WeChat26WeSeePageRecoverController;

@interface WSRecommendMgr : WSTemplateBaseMgr <IFunctionMsgExt, PBMessageObserverDelegate, IMinimizeTaskDelegateInterface>
{
    _Bool _isAuthOK;
...
- (void)preloadSharedPageWebViewIfNeeded:(unsigned long long)arg1;
