...
+ (void)ReportVoipStartCallWithRoomId:(unsigned long long)arg1 WithRoomKey:(long long)arg2 WithRoomType:(unsigned int)arg3 WithStartCallStatus:(int)arg4 WithNetType:(int)arg5;
