...
@interface ContactSelectView : UIView <MMTableViewDelegate, MMTableViewIndexViewDelegate, WCSearchDelegate, WCDataSearchDelegate, UITableViewDelegate, UITableViewDataSource, WCActionSheetDelegate, ContactsDataLogicDelegate>
{
