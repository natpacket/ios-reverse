...
@interface MailAttachmentControlView : MMUIView <UIImagePickerControllerDelegate, UINavigationControllerDelegate, WCActionSheetDelegate, MailAttachmentsViewDelegate>
{
