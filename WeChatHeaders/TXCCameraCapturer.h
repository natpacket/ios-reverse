...
@interface TXCCameraCapturer : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureMetadataOutputObjectsDelegate, TXIVideoCaptureInterface, TXICameraCapturerInterface>
{
