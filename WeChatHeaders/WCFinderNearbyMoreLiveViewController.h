...
#import "WCFinderNearbyLiveTabViewContainerDelegate-Protocol.h"
...
@class MMUIButton, NSMutableDictionary, NSString, UIColor, UIView, WCFinderCreateCoordinator, WCFinderEmptyTipsView, WCFinderLiveTabInfo, WCFinderMoreLiveReporter, WCFinderNearbyMoreLiveViewModel, WCFinderTabPageView;
...
- (void)onLiveTabViewContainerViewActionSearch:(id)arg1;
- (void)startLive;
- (void)showLiveHalfVC;
