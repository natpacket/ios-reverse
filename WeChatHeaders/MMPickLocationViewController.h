...
@class CLLocation, LocationRetriever, MMAutoSearchLogic, MMFloorPickView, MMLocationAttributeBanner, MMLocationPinView, MMMapView, MMPickLocationSearchView, NSMutableArray, NSString, POIItem, PickLocationManager, UIBarButtonItem, UIButton, UIImageView, UIPinchGestureRecognizer, UIView, WCUIAlertView;
@protocol MMPickLocationViewControllerDelegate;

@interface MMPickLocationViewController : MMUIViewController <MMTableViewDelegate, IGetPOIListMgrExt, ILocationMgrExt, UIGestureRecognizerDelegate, MMLocationAttributeBannerDelegate, LocationRetrieveDelegate, MMAutoSearchLogicDelegate, MMPickLocationActionDelegate, MMPickLocationDataActionDelegate, QMapViewDelegate, QMapViewIndoorDelegate, MMLocationPinViewDelegate, WCActionSheetDelegate>
{
...
- (void)stopGeocoder;
- (_Bool)getAddressByLocation:(id)arg1 ForRequestUserAddress:(_Bool)arg2;
