...
#import "MMAssetDragSelectDelegate-Protocol.h"
#import "MMAssetPickerControllerFinderAssetDelegate-Protocol.h"
#import "MMAssetPickerSliderDelegate-Protocol.h"
...
@class MMAlbum, MMAlbumAccessAuthView, MMAlbumAuthorizationReportObject, MMAlbumDropPickerController, MMAsset, MMAssetDragSelectHelper, MMAssetPickerActionBottomView, MMAssetPickerControllerProxyObject, MMAssetPickerControllerProxyObjectForAllAsset, MMAssetPickerControllerState, MMAssetPickerSlider, MMImagePickerVideoCompressQueue, MMScrollView, MMSightCameraViewController, MMTableView, MMUIButton, MMUIImageView, MMUILabel, NSDateFormatter, NSHashTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UIImageView, UILabel, UIView, VideoEncodeTask, WCFinderPreviewEditVideoCompositionTask, WCFinderSyncComposeResModel;
@protocol MMAssetPickerControllerDelegate, MMImagePickerControlCenter, UIViewControllerPreviewing;

@interface MMAssetPickerController : MMUIViewController <UIViewControllerPreviewingDelegate, MMImageCropperDelegate, WCActionSheetDelegate, MMAlbumDropPickerControllerDelegate, MMAssetPickerControllerFinderAssetDelegate, WCEditVideoViewControllerDelegate, MMAlbumAccessAuthViewDelegate, MMAssetCellDelegate, MMAssetViewDelegate, MMAssetDragSelectDelegate, WCFinderLongVideoChooseHelperDelegate, MMSightCameraViewControllerDelegate, MMAssetPickerSliderDelegate, UITableViewDataSource, UITableViewDelegate, MMImagePreviewBrowserControllerDelegate>
{
    ...
    MMUIButton *m_sendButton;
    MMUIButton *m_originImageCheck;
    MMUIButton *_assetSetCheck;
    MMUIImageView *_assetSetIconView;
    UILabel *_assetSetLabel;
    UILabel *_forceAssetsetSendTipsLabel;
...
@property(retain, nonatomic) UIView *assetSetContentView; // @synthesize assetSetContentView=_assetSetContentView;
...
- (void)onAssetSetBtnClick:(id)arg1;
...
- (void)setTopBottomBarHidden:(_Bool)arg1;
...
- (void)initBottomBar;
- (void)initAssetSetView;
- (void)initFooterViewButtonWithTitle:(id)arg1 andImage:(id)arg2;
- (void)hiddenAssetsetInfoPannel;
- (void)showAssetsetInfoPannel;
...
- (void)editVideoViewController:(id)arg1 requestToLaunchMJAppWithScene:(unsigned long long)arg2 launchType:(long long)arg3;
