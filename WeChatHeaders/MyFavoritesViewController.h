...
@class FavClickStreamData, FavMultiSelectToolView, FavWarningBannerView, MMTimer, MMUIWindow, NSString, UIButton, UIView;
@protocol MyFavoritesViewControllerDelegate;

@interface MyFavoritesViewController : FavBaseListViewController <FavForwardLogicDelegate, FavTagViewDelegate, WCActionSheetDelegate, WCNetworkMediaPlayerDelegate, FavSightViewDelegate, ViewLocationDelegate, MMTipsViewControllerDelegate, FavFullScreenImageViewControllerDelegate>
{
