...
#import "WCFinderMusicTopicPageViewModelDelegate-Protocol.h"

@class MMUIViewController, NSString, WCFinderFeedFlowView, WCFinderMusicTopicPageViewModel;
@protocol WCFinderFeedBaseViewControllerProtocol, WCFinderMusicTopicPageViewManagerDelegate;

@interface WCFinderMusicTopicPageViewManager : NSObject <WCFinderFeedFlowViewDataSource, WCFinderFeedFlowViewDelegate, WCFinderMusicTopicPageViewModelDelegate>
{
