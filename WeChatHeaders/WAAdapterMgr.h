...
@interface WAAdapterMgr : MMUserService <MMKernelExt, IMsgExt, MMConfigMgrExt, MMResourceMgrExt, MultiTalkMgrExt, IVOIPUILogicMgrExt, IExptServiceExt, INetworkStatusMgrExt, ServiceAuthExt, MonoServiceLogicExt, MonoServiceMsgLogicDelegate, MMServiceProtocol>
{
