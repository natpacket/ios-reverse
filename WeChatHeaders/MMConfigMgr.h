...
- (long long)getMultiTalkAgcHeadsetGainDb;
- (long long)getMultiTalkAgcPhoneGainDb;
- (long long)getMultiTalkAgcSpeakerGainDb;
...
- (long long)getVoipWaveAgcDamper;
- (long long)getVoipWaveAgcDampTHR;
- (long long)getVoipWaveAgcGainTHR;
- (long long)getVoipWaveAgcBase;
- (long long)getVoipWaveAgcDnTHR;
- (long long)getVoipWaveAgcRatio;
- (long long)getVoipWaveAgcTarget;
- (long long)getVoipWaveAgcHeadsetGain;
- (long long)getVoipWaveAgcPhnGain;
- (long long)getVoipWaveAgcSpkGain;
- (long long)getVoipWaveAgcMode;
...
- (long long)getEngineAgcHeadsetGainDb;
- (long long)getEngineAgcPhoneGainDb;
- (long long)getEngineAgcSpeakerGainDb;
...
- (long long)getVoipSwDecCabConfig;
- (long long)getVoipSwEncCabConfig;
- (long long)getVoipHwDecCabConfig;
- (long long)getVoipHwEncCabConfig;
