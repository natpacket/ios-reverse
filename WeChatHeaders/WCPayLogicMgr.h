...
@class MMTipsViewController, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, TenpayCertificate, WCPayAuthenticationPay, WCPayAuthenticationPayVerifySMSStruct, WCPayAvalibleBankCardBinInfo, WCPayBindCardInfo, WCPayBindInfo, WCPayBindInfoSMS, WCPayLocalCachedData, WCPayNetworkHelper, WCPayRealNameTipsViewController, WCPayResetPasswordInfo, WCRedEnvelopesSendControlLogic, WxSmCertUtil;

@interface WCPayLogicMgr : MMUserService <WCPayTransferMsgCheckCgiDelegate, WCPaySingleDownloadLogicExt, MMTipsViewControllerDelegate, ILinkEventExt, MMWebViewDelegate, MMResourceMgrExt, MMImageLoaderObserver, WCPayWalletChangeExt, MMKernelExt, MMServiceProtocol, WCPayNetworkHelperDelegate, MMPackageDownloadMgrExt, IMsgExt, IAutoVerifySMSExt, INewABTestMgrExt>
{
...
- (void)GetTransferUserName:(id)arg1 payChannel:(int)arg2 extendInfo:(id)arg3 qrcodeSenderUsername:(id)arg4;
