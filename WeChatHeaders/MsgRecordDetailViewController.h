...
@class CBaseContact, CMessageWrap, FavForwardLogicController, MMMsgMenuReporter, MMRichTextCoverView, MMTableView, MMUIWindow, NSArray, NSMutableDictionary, NSString, ScanQRCodeLogicController, UIView, WCActionSheetWithScanWXCode, WCPlayerConfigViewController;
...
+ (id)getFooterViewWithRichText:(id)arg1 size:(struct CGSize)arg2 font:(id)arg3;
+ (id)getFooterViewWithRichText:(id)arg1 size:(struct CGSize)arg2;
