...
@protocol MMFinderLiveConnectMicAnchorInvitePkContainerViewDelegate;

@interface MMFinderLiveConnectMicAnchorInvitePkContainerView : MMFinderLiveConnectMicBaseContainerView
{
    _Bool _isPkDisabled;
    id <MMFinderLiveConnectMicAnchorInvitePkContainerViewDelegate> _actionDelegate;
...
@property(retain, nonatomic) UILabel *pkUnavailableLabel; // @synthesize pkUnavailableLabel=_pkUnavailableLabel;
...
@property(nonatomic) __weak id <MMFinderLiveConnectMicAnchorInvitePkContainerViewDelegate> actionDelegate; // @synthesize actionDelegate=_actionDelegate;
...
- (id)initWithFinderContact:(id)arg1 pkState:(unsigned long long)arg2 disablePk:(_Bool)arg3 frame:(struct CGRect)arg4;
