...
@interface MMLiveViewController : MMUIViewController <TRTCCloudDelegate, MMLiveCommentViewDelegate, MMLiveConnectMicOperationPanelDelegate, MMAcceptAgreementResultViewControllerDelegate, MMTipsViewControllerDelegate, WAAppTaskMgrExt, MMLiveOperationViewDelegate, MMLiveCompleteViewControllerDelegate, MMLiveStarterViewControllerDelegate, MMLiveLogicDelegate, MMLiveTaskMgrExt, WCActionSheetDelegate, MMLiveContainerLogicControllerDelegate, INetworkStatusMgrExt>
{
