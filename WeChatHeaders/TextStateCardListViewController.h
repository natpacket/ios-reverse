...
#import "TextStateCardListCollectionGestureDelegate-Protocol.h"
#import "TextStateFriendSquareTransitionCardList-Protocol.h"
#import "UICollectionViewDataSource-Protocol.h"
#import "UICollectionViewDelegateFlowLayout-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class MMUIButton, MultipleTextStateCardView, NSIndexPath, NSString, TextStateCardListCollectionView, TextStateCardListFooterView, TextStateCardListSlidingWindowRefreshTask, TextStateModel, TextStateMusicPlayerCoordinator, UICollectionViewFlowLayout, UIPanGestureRecognizer, UIScreenEdgePanGestureRecognizer, UITapGestureRecognizer, UIView, UIViewPropertyAnimator, _TtC6WeChat31TextStateFriendSquareTransition;
@protocol TextStateCardListDataProvider, TextStateCardListDelegate;

@interface TextStateCardListViewController : MMUIViewController <TextStateFriendSquareTransitionCardList, TextStateBaseCardContentViewDelegate, TextStateCardListCollectionGestureDelegate, MultipleTextStateCardViewDelegate, UIGestureRecognizerDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
{
    _Bool _showFooter;
