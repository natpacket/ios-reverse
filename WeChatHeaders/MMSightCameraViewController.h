...
@class FinderVideoTemplateInfo, MMShortVideoParamModel, NSString, RecommendedMusicInfo, ShortVideoToolbar;
...
@interface MMSightCameraViewController : MMUIViewController <ShortVideoBarDelegate>
{
    ...
    unsigned long long _shortVideoToolBarTopBarToolItems;
...
@property(nonatomic) unsigned long long shortVideoToolBarTopBarToolItems; // @synthesize shortVideoToolBarTopBarToolItems=_shortVideoToolBarTopBarToolItems;
