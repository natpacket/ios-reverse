...
@class FinderLiveGestureInfo, MMFinderLiveResDownloadManager, NSString, UIColor;
...
@interface MMFinderLiveGestureInfo : NSObject
{
    ...
    MMFinderLiveResDownloadManager *_resourceDownloader;
...
- (void).cxx_destruct;
@property(retain, nonatomic) MMFinderLiveResDownloadManager *resourceDownloader; // @synthesize resourceDownloader=_resourceDownloader;
