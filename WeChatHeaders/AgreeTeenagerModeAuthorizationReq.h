...
@property(retain, nonatomic) NSString *businessKey; // @dynamic businessKey;
@property(nonatomic) unsigned int businessType; // @dynamic businessType;
@property(nonatomic) unsigned long long requestAuthorizationMsgId; // @dynamic requestAuthorizationMsgId;
