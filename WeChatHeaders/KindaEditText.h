...
@class MMDynamicColor, MMKEditTextOnEditorActionCallback, MMKEditTextOnFocusChangeCallback, MMKEditTextOnTextBeginChangeCallback, MMKEditTextOnTextChangedCallback, MMKEditTextOnTextEndEditingCallback, NSString, UILabel, UITextField, WCPayDecimalKeyboardView;
