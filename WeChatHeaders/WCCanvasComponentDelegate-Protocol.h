...
@class MMTableView, MMUIViewController, NSArray, NSMutableDictionary, NSNumber, NSString, POIInfo, UIColor, UIImage, UIView, UIViewController, WCAdWeAppInfo, WCAdvertiseInfo, WCCanvasComponent, WCCanvasComponentItem, WCCanvasMusicMgr, WCCanvasReportMgr, WCDataItem, WCWeAppBizTempSessionInfo;
