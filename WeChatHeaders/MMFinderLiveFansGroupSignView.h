...
+ (id)getRankImageWithRank:(unsigned long long)arg1;
+ (id)getFansGroupFontForUIStyle:(long long)arg1;
+ (struct CGSize)getFansGroupSignSizeWithName:(id)arg1 uiStyle:(long long)arg2 customFont:(id)arg3;
...
- (void)innerInit;
- (id)initWithUIStyle:(long long)arg1 uiMode:(long long)arg2 forceLayout:(_Bool)arg3;
