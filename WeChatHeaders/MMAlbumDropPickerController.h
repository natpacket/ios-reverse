...
@interface MMAlbumDropPickerController : NSObject <MMAlbumDropableTitleViewDelegate, UITableViewDelegate, UITableViewDataSource, PHPhotoLibraryChangeObserver>
{
    _Bool _isQuit;
