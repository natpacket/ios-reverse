...
#import "MMActionSheetImgSourceRowViewDelegate-Protocol.h"
...
@class AssetSetAnimationController, BrandMpVideoReporter, CAGradientLayer, CMessageWrap, CameraScanCodesMarkDotView, EditImageForwardAndEditLogicController, ForwardMessageLogicController, GetQRCodeInfoLogic, ImageBrowseButton, ImageScrollView, MMAdaptiveBubbleViewWithLabel, MMLRUCache, MMProgressViewEx, MMScrollActionSheet, MMTimer, MMUIActivityIndicatorView, MPCustomInteractiveHandler, MPDragDownGestureHandler, MsgImgDataLogic, MsgImgDelayEntryReporter, MsgImgFullScreenContainer, MsgImgPreviewData, MsgImgSearchPhashMemCache, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSOperationQueue, NSString, OCRTransHalfScreenViewController, QRCodeInMultiDisplayView, ScanQRCodeLogicController, ShareDataToOpenSDKController, SightIconView, UILabel, UIView, WCActionSheet, WCImageTranslateLogic;
@protocol MsgImgFullScreenTransitionComponent, MsgImgFullScreenTransitionDelegate, MsgImgFullScreenViewControllerDelegate;

@interface MsgImgFullScreenViewController : MMUIViewController <GetQRCodeInfoLogicDelegate, MMScrollActionSheetDelegate, RecentForwardScrollViewDelegate, SharePreConfirmViewDelegate, BaseScanLogicDelegate, WXVideoPlayerViewDelegate, WXVideoPlayerViewTouchDelegate, MsgImgDataLogicDelegate, ForwardMessageLogicDelegate, EditImageForwardAndEditLogicDelegate, WCImageTranslateDelegate, WCActionSheetDelegate, OCRTransHalfScreenViewControllerDelegate, QRCodeInMultiDisplayViewDelegate, WAWxMaterialRefreshExt, MMActionSheetQRCodeRowViewDelegate, MMActionSheetImgSourceRowViewDelegate, AssetTransitioning, UIViewControllerTransitioningDelegate, MsgImgFullScreenContainerDelegate, IDownloadImageExt, IMsgExt, IMsgRevokeExt>
{
    ...
    NSMutableSet *m_markTranslateSet;
    _Bool m_bShow;
    ...
    UIView *_maskView;
    AssetSetAnimationController *_assetAnimationController;
    ...
    MMLRUCache *_assetVCCache;
}

+ (_Bool)isHDImageDownloaded:(id)arg1;
+ (_Bool)isMiddleImgDownload:(id)arg1;
- (void).cxx_destruct;
@property(nonatomic) _Bool bAssetTransitioning; // @synthesize bAssetTransitioning=_bAssetTransitioning;
@property(retain, nonatomic) MMLRUCache *assetVCCache; // @synthesize assetVCCache=_assetVCCache;
...
@property(retain, nonatomic) AssetSetAnimationController *assetAnimationController; // @synthesize assetAnimationController=_assetAnimationController;
...
- (void)showAssetSetSpamWarnning;
- (void)showAssetSetSpamWarnningIfNeeded;
...
- (id)getAssetSetViewWithMsg:(id)arg1;
- (void)updateTransitionComponent:(id)arg1;
...
- (id)initWithMsgWrap:(id)arg1 originFrame:(struct CGRect)arg2 soundable:(_Bool)arg3 snapshotView:(id)arg4 needEdit:(_Bool)arg5 isShowSingleMsg:(_Bool)arg6 eScene:(unsigned long long)arg7 transitioningStyle:(unsigned long long)arg8 delegate:(id)arg9 msgImgDataLogic:(id)arg10;
