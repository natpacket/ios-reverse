...
- (void)dealloc;
- (void)showImageWithUrls:(id)arg1 current:(id)arg2 currentImage:(id)arg3 currentPos:(struct CGRect)arg4 isForbidForward:(_Bool)arg5 isShowMenu:(_Bool)arg6 config:(id)arg7;
