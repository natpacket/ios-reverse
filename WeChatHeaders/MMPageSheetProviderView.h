...
@class MMPageSheetBottomView, MMPageSheetNavigationBar, NSMutableArray, NSString, UIButton, UIPanGestureRecognizer;
@protocol MMPageSheetProviderViewDelegate;

@interface MMPageSheetProviderView : UIView <MMPageSheetNavigationBarDelegate, MMPageSheetConfigDelegate, UIGestureRecognizerDelegate>
{
    _Bool _isShowing;
