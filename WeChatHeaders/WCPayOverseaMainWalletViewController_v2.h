...
@class MMWebViewController, NSString, UICollectionView, WCBizLoadingView, WCPayComplianceHalfPage, WCPayOverseaIBGGetWalletCgi, WCPayOverseaIBGGetWalletCgiCache, WCPayOverseaMainWalletDataSource, WCPayOverseaPayFunctionListCgi_v2, WCPayOverseaPayFunctionListRespObject, WCPayOverseaReadActivityList;

@interface WCPayOverseaMainWalletViewController_v2 : WCBizBaseViewController <UICollectionViewDelegate, UICollectionViewDataSource, WCPayOverseaPayFunctionListCgiDelegate, WCPayOverseaIBGGetWalletCgiDelegate, WCActionSheetDelegate, WCPayNoticeBannerViewDelegate, MMWebViewDelegate>
{
    ...
    WCPayOverseaPayFunctionListCgi_v2 *_m_payFunctionCgi;
...
@property(retain, nonatomic) WCPayOverseaPayFunctionListCgi_v2 *m_payFunctionCgi; // @synthesize m_payFunctionCgi=_m_payFunctionCgi;
