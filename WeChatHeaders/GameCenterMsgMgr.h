...
@class GCFirstTimeMarker, GCMRedpointExposureControlModel, GCRedPointLogicTypeModel, GameCenterMessageRedPointInfo, GameCenterMsgDb, NSArray, NSMutableArray, NSMutableDictionary, NSString;
...
@interface GameCenterMsgMgr : MMUserService <IFunctionMsgExt, MMServiceProtocol, IMsgExt, MMImageLoaderObserver>
{
    ...
    GCFirstTimeMarker *_firstTimeAccessMaker;
...
@property(retain, nonatomic) GCFirstTimeMarker *firstTimeAccessMaker; // @synthesize firstTimeAccessMaker=_firstTimeAccessMaker;
@property(nonatomic) _Bool isInsideFirstTime; // @synthesize isInsideFirstTime=_isInsideFirstTime;
...
- (unsigned int)receiveActionStatusForMsg:(id)arg1 hasReceivedMsg:(_Bool)arg2;
...
- (void)updateNotifyContentExposured:(id)arg1;
