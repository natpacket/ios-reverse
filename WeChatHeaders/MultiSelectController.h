...
@class CContact, ForwardMessageLogicController, MMPageSheetBaseView, MsgDataSaveLogic, NSMutableArray, NSString, WWKMsgForwarder;
@protocol MultiSelectContollerDelegate;

@interface MultiSelectController : MMObject <WCActionSheetDelegate, EnterpriseSessionSelectViewControllerDelegate, EnterpriseBrandContactSelectViewControllerDelegate, MsgDataSaveLogicDelegate, MMPageSheetBottomViewDelegate, MMImageLoaderObserver, WWKMsgForwarderDelegate, ForwardMessageLogicDelegate, MFMailComposeViewControllerDelegate>
{
