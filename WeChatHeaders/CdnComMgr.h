...
- (_Bool)startUploadGameWithFileKey:(id)arg1 imagePath:(id)arg2 thumbPath:(id)arg3 aesKey:(basic_string_0ec669f3)arg4;
...
- (_Bool)StartDownloadImage:(id)arg1 HD:(_Bool)arg2 AutoDownload:(_Bool)arg3 Silent:(_Bool)arg4 disableHevc:(_Bool)arg5 behavior:(long long)arg6;
- (void)StopUploadImage:(id)arg1;
- (_Bool)StartUploadDetectImage:(id)arg1;
- (_Bool)StartUploadTransImage:(id)arg1;
- (_Bool)StartUploadImage:(id)arg1 enableHitCheck:(_Bool)arg2 disableHevc:(_Bool)arg3 lastHevcFail:(_Bool)arg4 filekey:(id)arg5 sendMsgFromCdn:(_Bool)arg6 attachPrepareRequest:(_Bool)arg7;
