...
#import "TextStatePublishCustomIconViewDelegate-Protocol.h"
...
@class CEmoticonWrap, EmoticonBoardView, MMGrowTextView, MMUIButton, MMUILabel, NSArray, NSDictionary, NSString, TextStateIcon, TextStatePublishConfiguration, TextStatePublishContentBuilder, TextStatePublishEmoticonView, TextStatePublishGuideView, TextStatePublishIconButton, TextStatePublishIconList, TextStatePublishInputBar, TextStatePublishMediaSwitchView, TextStatePublishReportObject, TextStatePublishSourceInfo, TextStatePublishSourceView, TextStatePublishTitleView, TextStateTopicGuideBubbleView, UIBarButtonItem, UIScreenEdgePanGestureRecognizer, UIScrollView, UITapGestureRecognizer, UIView, UIViewPropertyAnimator, WCInputController, WCLocationInfo, WCMomentsPrivacyParams;
