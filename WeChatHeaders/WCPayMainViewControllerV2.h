...
@class GetEUInfoResp, NSArray, NSString, NoticeItem, UICollectionView, UIImageView, UIView, WCPayComplianceHalfPage, WCPayMainViewLogicController, WCPayWalletEntryHeaderView;
