...
@class ForwardMessageLogicController, JSAPIHandleMPPageActionFavContext, JSAPIHandleMPPageActionShareFriendContext, JSAPIHandleMPPageActionShareTimelineContext, JSAPIHandleMPPageActionShowActionSheetContext, NSMutableDictionary, NSString, RecentForwardScrollView, UIImage, WCMomentsScrollActionSheet;

@interface WebviewJSEventHandler_handleMPPageAction : WebviewJSEventHandlerBase <MsgImgFullScreenViewControllerDelegate, ForwardMessageLogicDelegate, WCActionSheetDelegate, WCCommitViewResultDelegate, PBMessageObserverDelegate, MMScrollActionSheetDelegate, RecentForwardScrollViewDelegate>
{
