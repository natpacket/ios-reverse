...
#import "GCMessageViewModeUnreadCntProtocol-Protocol.h"
#import "GCMultiMessageViewModelProtocol-Protocol.h"

@class GCMultiChannelContainerView, GCMultiMessageViewModelConfig, GCTipLabel, NSMutableArray, NSString;

@interface GCMultiMessageViewModel : NSObject <GCMessageViewModeUnreadCntProtocol, GCMultiMessageViewModelProtocol>
{
    _Bool _hasBtmTip;
