...
#import "WCFinderUnreadMsgExt-Protocol.h"
...
@interface StrongNotificationMgr : MMUserService <IMMNewSessionMgrExt, MMKernelExt, StrongNotificationExclusiveMsgLogicDelegate, IRecordControllerExt, IOplogExt, IContactMgrExt, MMSightCameraExtention, WCFinderAppPushExt, WCFinderUnreadMsgExt, MMServiceProtocol, IMsgExt, PBMessageObserverDelegate>
{
