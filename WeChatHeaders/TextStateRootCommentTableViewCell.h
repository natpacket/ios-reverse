...
#import "TextStateBaseCommentCell.h"

#import "ILinkEventExt-Protocol.h"
#import "WCFinderFeedContentTextClickActionDelegate-Protocol.h"
#import "WCFinderHeadImageViewDelegate-Protocol.h"

@class FinderUniCommentMediaView, MMUIButton, NSString, UIButton, UIColor, UITapGestureRecognizer, UIView, WCCommentLikeView, WCFinderComment, WCFinderFeedContentTextView;
...
@interface TextStateRootCommentTableViewCell : TextStateBaseCommentCell <WCFinderFeedContentTextClickActionDelegate, ILinkEventExt, WCFinderHeadImageViewDelegate>
{
    ...
    _Bool _isSelfPost;
    id <TextStateRootCommentTableViewCellDelegate> _delegate;
    UIColor *_themeColor;
...
@property(nonatomic) __weak id <TextStateRootCommentTableViewCellDelegate> delegate; // @synthesize delegate=_delegate;
