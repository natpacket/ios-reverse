...
- (void)onLiveRewardQuotaOperationReport:(unsigned long long)arg1 quota:(id)arg2;
...
- (void)reportCommerceAction:(unsigned long long)arg1 withSessionID:(id)arg2 withRequestID:(id)arg3 withProductIDStr:(id)arg4 withAdItem:(id)arg5 withPbAdItem:(id)arg6 withCouponID:(id)arg7 withCouponItem:(id)arg8 extraInfo:(id)arg9;
- (void)reportCommerceAction:(unsigned long long)arg1 withSessionID:(id)arg2 withRequestID:(id)arg3 withProductID:(unsigned long long)arg4 withAdItem:(id)arg5 withPbAdItem:(id)arg6 withCouponID:(id)arg7 withCouponItem:(id)arg8 extraInfo:(id)arg9;
...
- (void)onCommerceAction:(unsigned long long)arg1 withSessionID:(id)arg2 withRequestID:(id)arg3 withProductID:(unsigned long long)arg4 withAdItem:(id)arg5 withPbAdItem:(id)arg6 withCouponID:(id)arg7 extraInfo:(id)arg8;
...
- (void)onSlideRoom:(id)arg1 exitLiveId:(unsigned long long)arg2;
