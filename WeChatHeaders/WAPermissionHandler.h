...
- (unsigned int)getPermissionIndexCount;
- (id)getAllPermissionStatesDescriptionForAllRunningState;
- (id)getAllPermissionStatesInTaskRunningState:(unsigned long long)arg1;
- (id)getPermissionStateDescriptionInAllRunningStateForIndex:(unsigned int)arg1;
- (unsigned int)getPermissionStateWithJSAPIIndex:(unsigned int)arg1 inTaskRunningState:(unsigned long long)arg2;
