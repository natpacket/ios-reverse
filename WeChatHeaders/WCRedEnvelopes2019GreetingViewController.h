...
#import "WCRedEnvAudioResMgrDelegate-Protocol.h"

@class AddEmoticonWrap, CEmoticonWrap, EmoticonBoardView, EmoticonCustomAddLogicController, GKImagePicker, KindaProxy, MMEmoticonView, MMToastViewController, MMUILabel, NSArray, NSMutableDictionary, NSNumber, NSString, PAGView, UIButton, UIImage, UIImageView, UIView, WCRedEnvelopesControlData, ZCWScrollNumView;
...
@interface WCRedEnvelopes2019GreetingViewController : MMUIViewController <IZCWScrollNumViewDelegate, EmoticonCustomAddLogicControllerDelegate, EmoticonBoardViewDelegate, BaseEmoticonViewDelegate, IStoreEmotionSingleDownloadMgrExt, WCActionSheetDelegate, CAAnimationDelegate, PAGViewListener, WCRedEnvAudioResMgrDelegate>
{
    ...
    UIView *_m_audioRecordShadowView;
...
@property(retain, nonatomic) UIView *m_audioRecordShadowView; // @synthesize m_audioRecordShadowView=_m_audioRecordShadowView;
