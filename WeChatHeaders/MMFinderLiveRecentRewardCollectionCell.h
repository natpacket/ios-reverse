...
@class MMCPLabel, MMFinderLiveFansGroupSignView, MMFinderLiveGlobalRankSignView, MMFinderLiveLiveRoleSignView, MMFinderLiveRecentRewardGiftsView, MMFinderLiveRecentRewardUserItem, MMFinderLiveTask, MMUIImageView, NSMutableArray, NSString, UIView;
