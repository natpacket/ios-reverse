...
#import "CameraScanCombineDetectorRouterDelegate-Protocol.h"
...
- (void)reportOcr:(id)arg1 cls:(unsigned char)arg2 clsScore:(float)arg3 color:(unsigned char)arg4 colorScore:(float)arg5 url:(id)arg6 codeType:(int)arg7;
- (void)doOcrAndReportInGlobalQueue:(id)arg1 url:(id)arg2 andCodeType:(BOOL)arg3;
