...
@class LiveRoomImg, MMFinderLiveConnectMicAllUserInfoView, MMFinderLiveGestureAnimationContainerView, MMFinderLiveReplayCompactMicUserInfoView, MMFinderLiveReplayConnectMicLogic, MMFinderLiveReplayMicInfoBackgroundDisplayLogic, MMFinderLiveResDownloadManager, MMFinderLiveWcPlayerView, MMLiveAudioModeAnimatedBackgroundPlayerViewModel, MMLiveTaskId, MMWebImageView, NSString, UIView;
...
@interface MMFinderLiveReplayMicInfoDisplayLogic : NSObject <MMFinderLiveCDNPlayerMicLogicDelegate, MMWebImageViewDelegate, MMFinderLiveConnectMicAllUserInfoViewLayoutInfoDelegate>
{
    ...
    MMFinderLiveGestureAnimationContainerView *_opposingAnchorGestureAnimationContainerView;
    ...
    MMWebImageView *_connectMicOtherAnchorCoverImageView;
    MMLiveAudioModeAnimatedBackgroundPlayerViewModel *_opposingAnchorBackgroundVideoViewModel;
    ...
    UIView *_connectMicOtherAnchorCoverView;
    NSString *_opposingAnchorBackgroundVideoUri;
    MMFinderLiveWcPlayerView *_opposingAnchorBackgroundVideoView;
...
@property(retain, nonatomic) MMFinderLiveWcPlayerView *opposingAnchorBackgroundVideoView; // @synthesize opposingAnchorBackgroundVideoView=_opposingAnchorBackgroundVideoView;
@property(retain, nonatomic) NSString *opposingAnchorBackgroundVideoUri; // @synthesize opposingAnchorBackgroundVideoUri=_opposingAnchorBackgroundVideoUri;
@property(retain, nonatomic) UIView *connectMicOtherAnchorCoverView; // @synthesize connectMicOtherAnchorCoverView=_connectMicOtherAnchorCoverView;
...
@property(retain, nonatomic) MMLiveAudioModeAnimatedBackgroundPlayerViewModel *opposingAnchorBackgroundVideoViewModel; // @synthesize opposingAnchorBackgroundVideoViewModel=_opposingAnchorBackgroundVideoViewModel;
@property(retain, nonatomic) MMWebImageView *connectMicOtherAnchorCoverImageView; // @synthesize connectMicOtherAnchorCoverImageView=_connectMicOtherAnchorCoverImageView;
...
@property(retain, nonatomic) MMFinderLiveGestureAnimationContainerView *opposingAnchorGestureAnimationContainerView; // @synthesize opposingAnchorGestureAnimationContainerView=_opposingAnchorGestureAnimationContainerView;
...
- (_Bool)insertOpposingAnchorAudioMicBackgroundVideoToPipRenderLayer;
- (_Bool)insertConnectMicOtherAnchorCoverImageViewToPIPRenderLayer;
...
- (void)updateLiveRoomAudioModeBackgroundVideoUri:(id)arg1 forOpposingAnchor:(_Bool)arg2;
- (void)startAudioModeBackgroundPlayerWithPath:(id)arg1 forOpposingAnchor:(_Bool)arg2;
- (void)configureAudioModeBackgroundForOpposingAnchor;
...
- (void)updateConnectMicOtherAnchorCoverImageViewAppearance:(_Bool)arg1;
