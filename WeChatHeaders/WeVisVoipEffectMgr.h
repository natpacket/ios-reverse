...
- (void)dealloc;
- (id)initWithGlContext:(id)arg1 sceneType:(long long)arg2 modelKeyArray:(id)arg3 SDKMode:(int)arg4 runDeviceType:(unsigned long long)arg5 isAllowFp16:(_Bool)arg6;
- (id)initWithGlContext:(id)arg1 sceneType:(long long)arg2 modelKeyArray:(id)arg3 SDKMode:(int)arg4;
- (id)initWithGlContext:(id)arg1 sceneType:(long long)arg2 modelKeyArray:(id)arg3 runDeviceType:(unsigned long long)arg4 isAllowFp16:(_Bool)arg5;
