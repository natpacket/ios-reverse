...
@class NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSOperationQueue, NSRecursiveLock, NSString;
...
@interface MMImageLoader : MMRootService <MMServiceProtocol>
{
    ...
    NSRecursiveLock *_lockImageSet;
}

+ (unsigned long long)preCleanGetCacheSize;
+ (unsigned long long)cleanCacheMgrMakeToClean;
- (void).cxx_destruct;
@property(retain, nonatomic) NSRecursiveLock *lockImageSet; // @synthesize lockImageSet=_lockImageSet;
@property(retain, nonatomic) NSOperationQueue *delegateQueue; // @synthesize delegateQueue=_delegateQueue;
@property(retain, nonatomic) NSRecursiveLock *lockRequest; // @synthesize lockRequest=_lockRequest;
...
- (void)onHandleHevcSdkError:(id)arg1 errorType:(unsigned int)arg2 idKey:(unsigned long long)arg3 rstCode:(unsigned int)arg4 reqCtx:(id)arg5 url:(id)arg6;
