...
@class FinderWordsTopicExtInfo, MMWebImageView, RichTextView, UIButton, UIImageView, UILabel, UIView, WCFinderBriefCardView;
...
+ (double)getTopicListSectionHeaderViewHeightWithTopicType:(unsigned long long)arg1 imageUrl:(id)arg2 topicTitle:(id)arg3 topicLocation:(id)arg4 topicDetailLocation:(id)arg5 topicCount:(unsigned long long)arg6 totalWatchCount:(unsigned long long)arg7 width:(double)arg8 wordsTopicExt:(id)arg9;
- (void).cxx_destruct;
...
- (void)updateTopicType:(unsigned long long)arg1 imageUrl:(id)arg2 topicTitle:(id)arg3 topicLocation:(id)arg4 topicDetailLocation:(id)arg5 topicCount:(unsigned long long)arg6 totalWatchCount:(unsigned long long)arg7 wordsTopicExt:(id)arg8 optionParams:(id)arg9;
