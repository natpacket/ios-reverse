...
@interface MJTemplateSessionStartAssetClippingOperation : MJTemplateSessionBaseOperation
{
    long long _status;
}
...
- (void)_startAssetClippingWithCompletionHandler:(CDUnknownBlockType)arg1;
- (id)boundTemplateId;
