...
@interface DataReportService : MMUserService <MMServiceProtocol>
{
...
- (void)reportCustomEvent:(id)arg1 target:(id)arg2 params:(id)arg3 routeRules:(id)arg4 isRtReport:(_Bool)arg5 isBringPageInfo:(_Bool)arg6;
...
- (void)reportStandardEvent:(id)arg1 time:(unsigned long long)arg2;
