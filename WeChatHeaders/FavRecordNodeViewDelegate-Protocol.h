...
@class FavRecordBaseNodeView, FavRecordImgNodeView, FavoritesItemDataField, MMMsgMenuReporter, MMRichTextCoverView, MMUIViewController, NSString, UIImageView, UITableView;
