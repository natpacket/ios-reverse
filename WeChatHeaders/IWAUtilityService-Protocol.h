...
@class NSArray, NSData, NSString, UIImage, UIScrollView, WAContact, WAJSCServiceInjectExtendScriptModel, WAReportJSApiActionItem, WAReportUserCloseWeAppWhenLoadingItem;
