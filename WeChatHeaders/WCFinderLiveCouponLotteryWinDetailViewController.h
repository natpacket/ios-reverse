...
@class MMFinderLiveLotteryGetPrizeMethodView, MMFinderLiveLotteryInfo, MMFinderLiveTask, MMFinderLiveTaskId, MMUIButton, MMUILabel, MilestoneLotteryCouponRecordInfo, MilestoneLotteryRedpacketInfo, NSString, RichTextView, UIImageView, UIScrollView, UIView, WCAddressBaseAddress;

@interface WCFinderLiveCouponLotteryWinDetailViewController : MMUIViewController <MMUIViewControllerDelegate, WCAddressEntranceControlLogicDelegate, ILinkEventExt, MMWebViewDelegate>
{
