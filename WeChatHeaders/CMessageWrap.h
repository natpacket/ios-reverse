...
@class AppMMScheduleItem, AppMsgShareItem, AppProductItem, AppTVItem, AssetsetMsgExtInfo, BrandMpVideoItem, BrandResortDigestInfo, CContact, CardTicketItem, EmoticonAppMsgItem, EmoticonSecurityInfoList, EmoticonSharedItem, EmotionDesignerSharedItem, EmotionPageSharedItem, FavoritesItem, GameLifeItem, GameShareCardItem, GameShareNameCard, GiftCardItem, GroupNoticeItem, HardWareItem, HistoryMsgsInfo, ImageInfo, LiteAppSharedItem, MMAsset, MMFinderLiveRedPacketMessage, MMLiveAppMsgInnerItem, MMMusicShareItem, MMReaderInfo, MMTemplateMsg3rdAppShowItem, MPPageIdentityInfo, MallProductItem, MessageExpItem, NSArray, NSData, NSMutableArray, NSMutableDictionary, NSString, NotifyMsgItem, OpenSDKAppBrandItem, PatMessageWrap, PushMailWrap, ScanCodeHistoryItem, ShareMsgObj, StrongNotificationItemPB, TingShareCategoryItem, TingShareListenItem, TingShareLyricsItem, VideoUploadStatInfo, VoiceAppMsgItem, WAAppMsgItem, WCCanvasPageItem, WCFinderClubSystemMessage, WCFinderContentColumnSharedItem, WCFinderLiveProductShareItem, WCFinderLiveShareItem, WCFinderLiveShopWindowShareItem, WCFinderMessageGuaranteeItem, WCFinderMessageShareNameCard, WCFinderMessageVerifyItem, WCFinderOrderShareItem, WCFinderShareItemContainer, WCFinderShareToMomentsItem, WCFinderTopicShareItem, WCMegaVideoShareItem, WCPayExtensionInfo, WCPayInfoItem, WCPayThirdInfo, WSVideoModel, WXSecretMsgItem, WebviewSharedItem, iWatchAppMsgItem;
...
+ (id)getPathOfNormalImageMessage:(id)arg1;
...
+ (void)initialize;
+ (id)localBubbleMessageWrapToUsername:(id)arg1 withWordingId:(int)arg2 isVideo:(_Bool)arg3 roomID:(unsigned long long)arg4 roomKey:(unsigned long long)arg5 inviteID:(unsigned int)arg6 inviteID64:(unsigned long long)arg7 duration:(unsigned int)arg8 isCaller:(_Bool)arg9 needRedDot:(_Bool)arg10 isIlink:(_Bool)arg11;
...
+ (id)localBubbleMessageWrapToUsername:(id)arg1 withWordingMsg:(id)arg2 isVideo:(_Bool)arg3 roomID:(unsigned long long)arg4 roomKey:(unsigned long long)arg5 inviteID:(unsigned int)arg6 inviteID64:(unsigned long long)arg7 duration:(unsigned int)arg8 isCaller:(_Bool)arg9 needRedDot:(_Bool)arg10 isIlink:(_Bool)arg11;
...
@property(retain, nonatomic) AssetsetMsgExtInfo *m_oAssetsetExtInfo; // @dynamic m_oAssetsetExtInfo;
