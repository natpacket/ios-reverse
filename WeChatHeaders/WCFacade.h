...
- (_Bool)unLikeObject:(id)arg1 ofUser:(id)arg2 extraInfo:(id)arg3;
...
- (void)setLayoutStylesOfContent:(id)arg1 withUserComment:(id)arg2 width:(double)arg3 isTiger:(_Bool)arg4;
- (id)layoutStylesOfContentWithUserComment:(id)arg1 width:(double)arg2 isTiger:(_Bool)arg3;
- (void)removeContentHeightForWidth:(double)arg1 withDataItem:(id)arg2 isTiger:(_Bool)arg3;
- (void)setContentHeight:(double)arg1 withUserComment:(id)arg2 width:(double)arg3 isTiger:(_Bool)arg4;
- (double)contentHeightWithUserComment:(id)arg1 width:(double)arg2 isTiger:(_Bool)arg3;
