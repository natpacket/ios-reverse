...
#import "WCFinderMinimizeGestureAnimatorDelegate-Protocol.h"
#import "WCFinderTrailingAnimatorDelegate-Protocol.h"

@class NSMutableArray, NSString, UIPanGestureRecognizer, UIScreenEdgePanGestureRecognizer, UIView, UIViewController, WCFinderMinimizeGestureAnimator, WCFinderTransitionAnimatorList, WCFinderTransitionUserInfo;
...
+ (void)recardTrailingAnimator:(id)arg1 forVC:(id)arg2;
...
- (void)_invokeEndDismissHookBlocks:(_Bool)arg1;
- (void)_invokeWillDismissHookBlocks;
