...
- (void)finderMoreLivePageViewMangerEnterLive:(WCFinderNearbyMoreLivePageViewManager *)arg1 dataItem:(WCFinderDataItem *)arg2 isFold:(_Bool)arg3 index:(unsigned long long)arg4;
