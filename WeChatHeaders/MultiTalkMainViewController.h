...
#import "MultiTalkMembersViewDelegate-Protocol.h"
...
@class CContact, MMTimer, MMUIButton, MMUILabel, MMUIView, MinimizeNewTransitionController, MultiTalkBeforeTalkingOperateView, MultiTalkBottomOperatePanel, MultiTalkHDHeadView, MultiTalkScreenSharingLogic, MultitalkSecondOperateView, NSArray, NSDictionary, NSString, UIImageView, UIView, VoipDescriptionButton, WCUIAlertView;
@protocol MultiTalkMainViewControllerDelegate, MultiTalkMembersViewProtocol;

@interface MultiTalkMainViewController : MMUIViewController <MultiTalkMgrExt, MMNewMultiSelectContactsViewControllerDelegate, MultiTalkMembersViewDelegate, UIViewControllerTransitioningDelegate, MultiTalkBeforeTalkingOperateViewDelegate, MultiTalkBottomOperatePanelDelegate, MultitalkSecondOperateViewDelegate, IRecordPermissionCheckExt, MultiTalkScreenSharingLogicDelegate, MMTipsViewControllerDelegate, WCActionSheetDelegate, MinimizeNewTransitionControllerDelegate, WCCameraModuleDelegate, MultiTalkMainWindowDelegate>
{
