...
@class CContact, CMessageWrap, ForwardMessageLogicController, MMTipsViewController, MMUINavigationController, NSArray, NSMutableDictionary, NSString, OpenApiAppMsgGenerator, OpenApiParameter, WAContactGetter, WXMediaInternalMessage;
...
@interface SendAppMsgHandlerV2 : MMObject <SessionSelectControllerDelegate, ShareMessageConfirmLogicHelperDelegate>
{
    ...
    OpenApiAppMsgGenerator *_appMsgGenerator;
}
...
- (void)handleSuccessGenerateMsg:(id)arg1 redirectUrl:(id)arg2 extraInfo:(id)arg3;
