...
@class CALayer, EditImageCropOverlayView, EditImageDeleteBarView, EditImageMusicLyricsWidgetTool, EditImagePOITool, EditImageScrollView, EditImageTextTool, EditImageWidgetTool, MMTimer, NSArray, NSMutableArray, NSString, UIColor, UIImage, UIPanGestureRecognizer, UITapGestureRecognizer, UIView, WCEditPanGestureFilter, WCEditViewControllerUIConfig;
...
@property(retain, nonatomic) EditImageTextTool *textWidget; // @synthesize textWidget=_textWidget;
