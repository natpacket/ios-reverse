...
- (CDStruct_869f9c67)measureText:(basic_string_0ec669f3)arg1;
- (void)strokeText:(basic_string_0ec669f3)arg1 x:(float)arg2 y:(float)arg3;
- (void)fillText:(basic_string_0ec669f3)arg1 x:(float)arg2 y:(float)arg3;
- (void)drawText:(void *)arg1 text:(basic_string_0ec669f3)arg2 x:(float)arg3 y:(float)arg4 maxWidth:(float)arg5 paint:(const void *)arg6;
