...
@interface FileDetailViewController : MMUIViewController <WCActionSheetDelegate, FileDetailLogicDelegate, UIScrollViewDelegate, UIGestureRecognizerDelegate, WKNavigationDelegate, MMCircleProgressViewDelegate, MinimizationTransitionControllerDelegate, WAWxMaterialRefreshExt, FullScreenGestureDelegate>
{
