...
@class EditImageLogicController, EditVideoLogicController, MMAssetPickerController, MMFinderLiveImagePickerParams, MMImagePickerControllerPreviewReportObject, NSArray, NSMutableDictionary, NSString, WCFinderEditOptionModel, WCFinderPickerTemplateParams;
