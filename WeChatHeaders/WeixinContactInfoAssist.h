...
@class CContact, CMessageWrap, ContactRelatedGroupLogic, MMTableViewInfo, NSDictionary, NSString, SendVerifyMsgLogicController, UIButton, UILabel, UIStackView, WCFinderContactFinderAssist;
