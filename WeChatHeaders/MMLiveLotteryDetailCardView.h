...
@class MMFinderLiveLotteryDisplayLogic, MMFinderLiveLotteryInfo, MMFinderLiveTask, MMFinderLiveTaskId, MMHeadImageView, MMLiveLotteryCardGoodsView, MMLiveLotteryWinnerRecordListView, MMUIButton, MMUILabel, NSString, RichTextView, UIImage, UIImageView, UILabel, WCAddressBaseAddress;
