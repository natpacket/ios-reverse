...
@class BrandTemplateMsgAuthMessageBubbleModel, MMBrandHeadImageView, MMUIButton, MMUILabel, MultiColumnReaderMessageCellMainContentView, MultiColumnReaderMessageViewModel, NSString, UIButton, UIImageView, UILabel, WAContactGetter, WCSubscriptionNotifyActionHeaderView;
