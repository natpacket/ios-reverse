...
@class NSDateFormatter, NSMutableDictionary, WCTDatabase, WCTTable;
...
- (_Bool)updateFinderMembershipFeedFirstPageCacheWithUsername:(id)arg1 pageType:(unsigned long long)arg2 dataArray:(id)arg3;
...
- (void)mergeDataItemExtraInfoWithDataArray:(id)arg1 entryScene:(unsigned long long)arg2 scene:(unsigned long long)arg3;
- (_Bool)saveDataItemsAndExtraInfo:(id)arg1 entryScene:(unsigned long long)arg2 scene:(unsigned long long)arg3;
...
- (_Bool)saveJumpInfoContainer:(id)arg1 withTid:(id)arg2 scene:(unsigned long long)arg3 config:(id)arg4;
- (void)cleanExpiredJumpInfoContainer;
- (_Bool)saveAdJumpInfoArray:(id)arg1 tid:(id)arg2 scene:(unsigned long long)arg3;
- (_Bool)deleteJumpInfoWithPrimaryId:(id)arg1 svrSourceType:(unsigned long long)arg2 scene:(unsigned long long)arg3;
- (id)getJumpInfoWithPrimaryId:(id)arg1 svrSourceType:(unsigned long long)arg2 scene:(unsigned long long)arg3;
- (_Bool)saveJumpInfo:(id)arg1 primaryId:(id)arg2 scene:(unsigned long long)arg3;
...
- (id)getLocalStreamFirstPage:(long long)arg1 feedType:(unsigned long long)arg2 limitCount:(unsigned long long)arg3;
...
- (_Bool)addSessionBufferWithTid:(id)arg1 scene:(unsigned long long)arg2 sessionString:(id)arg3 extraKey:(id)arg4;
...
- (id)getContactOneTimeInfoWithUsername:(id)arg1 entryScene:(unsigned long long)arg2 commentScene:(unsigned long long)arg3;
...
- (_Bool)updateMonoDataWithTid:(id)arg1 monoData:(id)arg2;
...
- (void)createFinderLiveShopWindowShareInfoTableName;
