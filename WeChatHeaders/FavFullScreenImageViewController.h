...
@class EditImageForwardAndEditLogicController, MMFullScreenItemView, MMScrollView, NSMutableArray, NSString, OCRTransHalfScreenViewController, QRCodeInMultiDisplayView, ScanQRCodeLogicController, SimpleImgInfo, UIView, WCActionSheetWithScanWXCode, WCImageTranslateLogic;
@protocol FavFullScreenImageViewControllerDelegate;

@interface FavFullScreenImageViewController : FullScreenViewController <FavForwardLogicDelegate, EditImageForwardAndEditLogicDelegate, WCImageTranslateDelegate, QRCodeInMultiDisplayViewDelegate, OCRTransHalfScreenViewControllerDelegate, UIScrollViewDelegate, scrollViewDelegate, FavImageFullScreenViewContainerDelegate, WCActionSheetDelegate, BaseScanLogicDelegate>
{
