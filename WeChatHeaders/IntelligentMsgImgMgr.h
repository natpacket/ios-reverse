...
- (id)getIntelligentMsgFaceAlbumSurfaceTempDirPath;
- (id)getIntelligentMsgFaceAlbumSurfaceDirPath;
...
- (id)getFaceAlbumSurfaceImage:(id)arg1;
...
- (void)setUpdateFaceAlbumWithIntelligentMsgModelFileHadChange;
- (void)executeUpdateFaceAlbumWithIntelligentMsgModelFileChange;
- (void)updateFaceAlbumWithIntelligentMsgModelFileChange;
...
- (void)initData;
- (id)init;
- (void)reportIntelligentMsgSearchInputQueryActionLog:(id)arg1 userName:(id)arg2 searchSessionId:(id)arg3 isHadPriorityBuildIndex:(_Bool)arg4;
- (void)reportIntelligentMsgSearchClickPictureActionLog:(id)arg1 userName:(id)arg2 searchSessionId:(id)arg3 isHadPriorityBuildIndex:(_Bool)arg4 searchQuery:(id)arg5 keyWord:(id)arg6 peopleCnt:(unsigned int)arg7 imageSendTime:(unsigned int)arg8 tab:(unsigned int)arg9;
- (void)reportIntelligentMsgSearchClickFigureActionLog:(id)arg1 userName:(id)arg2 searchSessionId:(id)arg3 isHadPriorityBuildIndex:(_Bool)arg4 searchQuery:(id)arg5 peopleCnt:(unsigned int)arg6;
- (void)reportIntelligentMsgSearchResultActionLog:(id)arg1 userName:(id)arg2 action:(unsigned int)arg3 searchSessionId:(id)arg4 isHadPriorityBuildIndex:(_Bool)arg5 searchQuery:(id)arg6 keyWord:(id)arg7 imageCnt:(unsigned int)arg8 peopleCnt:(unsigned int)arg9 finderCnt:(unsigned int)arg10 searchCost:(unsigned int)arg11;
- (void)reportIntelligentMsgSearchClickCancelActionLog:(id)arg1 userName:(id)arg2 searchSessionId:(id)arg3 isHadPriorityBuildIndex:(_Bool)arg4 searchQuery:(id)arg5 searchCost:(unsigned int)arg6;
- (void)reportIntelligentMsgSearchActionLog:(id)arg1 userName:(id)arg2 action:(unsigned int)arg3 searchSessionId:(id)arg4 isHadPriorityBuildIndex:(_Bool)arg5 printQuery:(id)arg6 searchQuery:(id)arg7 searchScene:(unsigned int)arg8 tab:(unsigned int)arg9;
- (void)reportIntelligentMsgStartUsingActionLog:(id)arg1 userName:(id)arg2 action:(unsigned int)arg3;
- (void)reportIntelligentMsgImgClickCategoryWordActionLog:(id)arg1 userName:(id)arg2 searchSessionId:(id)arg3 classification:(id)arg4 isHadPriorityBuildIndex:(_Bool)arg5;
- (void)reportIntelligentMsgBrowseViewControllerClickToSearchBannerActionLog:(id)arg1 userName:(id)arg2 isPopUp:(_Bool)arg3;
- (void)reportIntelligentMsgBrowseViewControllerActionLog:(id)arg1 userName:(id)arg2 action:(unsigned int)arg3;
- (void)reportIntelligentMsgImgExposureActionLog:(id)arg1 userName:(id)arg2 scene:(unsigned int)arg3 imageAllCount:(unsigned long long)arg4;
