...
- (void)createRequest;
- (id)initWithObjectid:(unsigned long long)arg1 nonceID:(id)arg2 rootCommentID:(unsigned long long)arg3 scene:(unsigned long long)arg4 pullScene:(unsigned long long)arg5 identityScene:(unsigned long long)arg6 rootCommentLastBuffer:(id)arg7 direction:(unsigned long long)arg8 successBlock:(CDUnknownBlockType)arg9 failureBlock:(CDUnknownBlockType)arg10;
