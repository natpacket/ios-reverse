...
@interface OMJPlaybackOverlayView : UIView <UIGestureRecognizerDelegate>
{
    ...
    struct vector<double, std::allocator<double>> _rotationSnapValues;
    double _rotationSnapDistance;
    struct vector<double, std::allocator<double>> _positionXSnapValues;
    struct vector<double, std::allocator<double>> _positionYSnapValues;
    ...
    NSLayoutConstraint *_horizontalGuideLineHeightConstraint;
    struct CGRect _canvasFrame;
}

- (id).cxx_construct;
- (void).cxx_destruct;
@property(retain, nonatomic) NSLayoutConstraint *horizontalGuideLineHeightConstraint; // @synthesize horizontalGuideLineHeightConstraint=_horizontalGuideLineHeightConstraint;
...
- (void)internalUpdateScale:(double)arg1;
