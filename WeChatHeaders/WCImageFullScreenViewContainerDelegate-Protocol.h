...
@class CContact, FavoritesItem, MMUIViewController, NSString, QRCodeInMultiDisplayView, UIImage, UIViewController, WCDataItem, WCImageFullScreenViewContainer, WCMediaItem;
