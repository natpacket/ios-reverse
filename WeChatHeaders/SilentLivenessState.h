...
- (void)checkBestImage:(struct Mat)arg1 withTrackInfo:(CDStruct_c559757e)arg2 withInRectRatio:(float)arg3 withBlurScore:(double)arg4;
- (vector_8ca568ff)covnertFaceShape:(void *)arg1;
- (void)addFaceShapePoint:(vector_dc67b4ed)arg1 withFacePoints:(void *)arg2;
- (void)reset;
- (void)exit;
- (void)enter;
- (void)unload;
