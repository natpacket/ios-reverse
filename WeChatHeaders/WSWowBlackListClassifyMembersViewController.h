...
@interface WSWowBlackListClassifyMembersViewController : MMUIViewController <WCActionSheetDelegate, MMTableViewDelegate, NewChatRoomMemberItemViewDelegate, MultiSelectContactsViewControllerDelegate, IContactMgrExt, WCCreateNewGroupViewControllerDelegate, UITableViewDataSource, UITableViewDelegate, ITopStoryColikeExt>
{
    _Bool _deleteStatus;
