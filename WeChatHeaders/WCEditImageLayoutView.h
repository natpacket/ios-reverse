...
@class EditImageCropGridView, EditImageCropOverlayView, EditImageCropToolBarView, EditImageCropToolBarViewModel, EditImageEmotionToolAttrView, EditImageMosaicToolAttrView, EditImagePenToolAttrView, EditImageTextToolV2, EditVideoBGMView, EditVideoMusicController, MMTimer, MMUIButton, MMUIImageView, NSArray, NSMutableArray, NSMutableDictionary, NSString, RecommendedMusicInfo, UIButton, UIImage, UIImageView, UILabel, UIPanGestureRecognizer, UIView, WCEditFilterToolAttrView, WCEditImageScrollView, WCEditLoadingModeButton, WCEditSelectedCollectionView, WCEditViewControllerUIConfig;
