...
#import "MsgFullScreenInputDelegate-Protocol.h"
...
#import "WXKeyBoardActiveReceiver-Protocol.h"
...
@interface MMInputToolView : MMUIView <SelectAttachmentViewControllerDelegate, WCActionSheetDelegate, MMQuickSendEmoticonViewDelegate, EmoticonSearchViewControllerDelegate, BaseEmoticonViewDelegate, EmoticonBoardViewDelegate, RelatedEmoticonHalfScreenViewControllerDelegate, RecordViewDelegate, MMTransparentButtonDelegate, SolitaireTipsViewDelegate, MMGrowTextViewDelegate, WXKeyBoardActiveReceiver, TranslateToolViewDelegate, TranslateLanguageSelectViewDelegate, WASendSessionMsgViewDelegate, MMInputMsgReferDelegate, EmoticonInputRecommendMgrExt, WCGroupUndoneActionDelegate, MsgFullScreenInputDelegate, UITextViewDelegate, ISysCallCheckExt, IRecordPermissionCheckExt>
{
