...
@interface WCPayAddPayCardLogic : WCPayControlLogic <FaceRecogPayHandlerDelegate, WCPayBankElementQueryCgiDelegate, MMUseCaseCallback, WCPayFillCardInfoViewControllerDelegate, WCPayFillCardNumberViewControllerDelegate, WCPayPayPwdViewControllerDelegate, WCPayVerifyPayCardViewControllerDelegate, WCPayTenpayImportCardInfoViewControllerDelegate>
{
