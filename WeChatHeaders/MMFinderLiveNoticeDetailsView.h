...
@class FinderLiveNoticeInfo, MMFinderLiveNoticePosterModel, MMWebImageView, NSString, UIButton, UIImage, UIImageView, UILabel, WCFinderContact, WCFinderHeadImageView;
