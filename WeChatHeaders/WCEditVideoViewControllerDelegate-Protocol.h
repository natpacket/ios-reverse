...
@class EditVideoAttr, NSString, UIImage, WCEditVideoViewController, WCFinderPostSessionModel;
...
- (void)editVideoViewController:(WCEditVideoViewController *)arg1 requestToLaunchMJAppWithScene:(unsigned long long)arg2 launchType:(long long)arg3;
