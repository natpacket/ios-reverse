...
@class CAGradientLayer, FavTagTableView, MMTableView, MyUIScrollView, NSArray, NSMutableArray, NSMutableDictionary, NSString, UIColor, UIImageView, UILabel, UIScrollView, UITextField, UIView, WCColorProxy, WCSTokenPickLogic;
@protocol NewContactsSearchPanelViewDelegate;

@interface NewContactsSearchPanelView : MMUIView <FavTagEditViewDelegate, MMTableViewDelegate, MMTableViewIndexViewDelegate, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UIScrollViewDelegate, MyUIScrollViewDelegate>
{
