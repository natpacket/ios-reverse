...
#import "QScaleViewDelegate-Protocol.h"
...
#import "glOverlayGestureClickDelegate-Protocol.h"

@class NSArray, NSMutableArray, NSMutableSet, NSString, QAOIMarkerManager, QAnnotationContainerView, QAppKeyCheck, QBaseVisualLayerManager, QBasicMapView, QBasicMapViewLayer, QConfigManager, QConfigPreference, QCustomLayerManager, QDataChecker, QEngineResourceManager, QHandDrawTileOverlay, QIndoorBuilding, QIndoorLevel, QIndoorManager, QIntersectionOverlayManager, QLayerManager, QLocalStateCollector, QMapContentView, QMapDataManager, QMapViewAccessibilityElement, QMarkerManager, QMediator, QOverlayContainer, QPointEventMananger, QScaleView, QStatisticer, QStyleManager, QTileOverlayManager, QTrafficManager, QUniversalMapCounter, QUserLocation, QUserLocationAccessibilityElement, QUserLocationManager, QUserLocationPresentation, QWorldTileOverlay, QWorldTileOverlayCustomProvider, TBRegionChangeDistributor, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
