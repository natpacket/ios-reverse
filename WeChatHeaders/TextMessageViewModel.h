...
@interface TextMessageViewModel : CommonMessageViewModel <RichTextLayoutDelegate, ISolitaireMgrExt, ITranslateMsgMgrExt>
{
    ...
    _Bool _foldText;
    _Bool _forbidLongSplit;
    _Bool _animateEmojiHasBeenPlayed;
    _Bool _isFirstAccess;
    unsigned char _customRotorElementIndex;
...
@property(nonatomic) unsigned char customRotorElementIndex; // @synthesize customRotorElementIndex=_customRotorElementIndex;
...
@property(nonatomic) _Bool forbidLongSplit; // @synthesize forbidLongSplit=_forbidLongSplit;
