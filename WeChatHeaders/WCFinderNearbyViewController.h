...
#import "WCFinderNearbyRelatedViewControllerDelegate-Protocol.h"
...
@class NSMutableDictionary, NSString, NSTimer, UICollectionView, UIImageView, UILabel, UITapGestureRecognizer, WCFinderNearbyViewModel, WCFinderStreamFooterView, WCFinderStreamHeaderView, WCFinderStreamLayout, WCFinderStreamLiveCollectionViewCell;
