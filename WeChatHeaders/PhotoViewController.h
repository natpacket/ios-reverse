...
@class CMessageWrap, MMUILabel, MultiImageScrollView, NSMutableArray, NSMutableDictionary, NSSet, NSString, OCRTransHalfScreenViewController, QRCodeInMultiDisplayView, ScanQRCodeLogicController, WCActionSheetWithScanWXCode, WCImageTranslateLogic;
@protocol PhotoViewControllerDelegate;

@interface PhotoViewController : WCDragToCloseViewController <BaseScanLogicDelegate, WCImageTranslateDelegate, QRCodeInMultiDisplayViewDelegate, OCRTransHalfScreenViewControllerDelegate, MultiImageScrollViewDelegate, IHttpCacheExt, WCActionSheetDelegate>
{
...
- (id)getDetectImageFilePath;
- (void)savePhotoToLocal:(id)arg1 picPath:(id)arg2;
