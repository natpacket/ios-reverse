...
@interface BaseMessageCellView : BaseChatCellView <WCActionSheetDelegate, WCForceTouchTriggerLongPressProtocol, WCForceTouchPreviewProtocol>
{
...
- (id)favoriteMenuItem;
- (_Bool)canShowForwardToFinderClub;
