...
#import "WCFinderClubExt-Protocol.h"
...
@interface ChatRoomInfoViewController : MMUIViewController <MsgSearchHelperDelegate, MMNewTipsMgrExt, WCFinderClubExt, MMTableViewDelegate, ChatRoomMemberGridViewDelegate, MMTableViewInfoDelegate, contactInfoDelegate, IContactMgrExt, IGroupMgrExt, WCActionSheetDelegate, IAutoSetRemarkExt, AddMemLogicDelegate, ViewMemLogicDelegate, DelMemLogicDelegate, ChatRoomManagementDelegate, IntelligentMsgBrowseResultCommonDelegate>
{
