...
@interface HttpClientAppleImpl : NSObject <NSURLSessionDataDelegate>
{
    ...
    struct Config {
        ...
        _Bool is_keep_alive;
        basic_string_0ec669f3 socks5_proxy_host;
        unsigned short socks5_proxy_port;
        basic_string_0ec669f3 socks5_proxy_user;
        basic_string_0ec669f3 socks5_proxy_password;
    } _config;
}
