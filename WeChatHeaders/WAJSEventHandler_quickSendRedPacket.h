...
@interface WAJSEventHandler_quickSendRedPacket : WAJSEventHandler_BaseEvent <SessionSelectControllerDelegate, SharePreConfirmViewDelegate, WCRedEnvelopesSendControlLogicDelegate, MMUIViewControllerDelegate>
{
