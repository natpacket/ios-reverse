...
@interface CBaseContact : NSObject <PBCoding, NSCoding>
{
    ...
    unsigned long long m_uiTypeExt;
    ...
    NSString *_m_authIconUrl;
}

+ (_Bool)isWeChatPayContactUsername:(id)arg1;
...
@property(nonatomic) unsigned long long m_uiTypeExt; // @synthesize m_uiTypeExt;
...
- (void)setMyTeenagerModeGuardian:(_Bool)arg1;
- (_Bool)isMyTeenagerModeGuardian;
- (void)setMyTeenagerModeWard:(_Bool)arg1;
- (_Bool)isMyTeenagerModeWard;
