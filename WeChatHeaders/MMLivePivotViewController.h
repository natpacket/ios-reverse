...
#import "MMLivePivotCollectionViewScrollDelegate-Protocol.h"
#import "MMLivePivotCollectionViewUpdateDataExt-Protocol.h"
#import "MMLivePivotItemViewControllerExt-Protocol.h"
#import "MMLivePivotPanGestureExt-Protocol.h"
#import "MMLivePivotViewDelegate-Protocol.h"
#import "MMLivePreviewRelatedViewModelDelegate-Protocol.h"
#import "MMLiveRoomDataCenterExt-Protocol.h"
#import "UICollectionViewDelegate-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"
#import "WCFinderLiveHomePageViewControllerDelegate-Protocol.h"

@class FinderCommByPass, MMFinderLivePivotEducationView, MMFinderLivePreviewExitButton, MMFinderLiveRelatedLiveParams, MMLiveDisplayLinkAnimator, MMLivePivotCollectionView, MMLivePivotView, MMLivePreviewRelatedViewModel, MMLiveTaskId, MMLiveView, MMTimer, MMUILabel, MMUIView, NSArray, NSData, NSIndexPath, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UICollectionView, UIImageView, UIPanGestureRecognizer, UIView, UIViewPropertyAnimator, WCFinderLiveBaseLogReporter, WCFinderLiveHomePageViewController, WCLiveBlurButton;
@protocol MMLiveContainerDisplayViewProtocol, MMLiveMorphDismissTarget;

@interface MMLivePivotViewController : MMUIViewController <UIGestureRecognizerDelegate, MMLivePivotCollecitonViewZoomAnimatorExt, MMLivePivotItemViewControllerExt, MMLiveRoomDataCenterExt, MMLivePivotPanGestureExt, MMLivePreviewRelatedViewModelDelegate, MMLivePivotCollectionViewScrollDelegate, MMLivePivotCollectionViewUpdateDataExt, WCFinderLiveHomePageViewControllerDelegate, UICollectionViewDelegate, MMLivePivotViewDelegate, MMLiveContainerLogicControllerDelegate, MMLiveConflictHandling, MMLiveContainerLogicTargetViewControllerDelegate>
{
...
- (void)switchLiveWithFinderLiveContentVMs:(id)arg1 exportIds:(id)arg2 selectedIndex:(id)arg3 commentScene:(unsigned long long)arg4;
- (void)switchLiveWithFinderLiveContentVMs:(id)arg1 selectedIndex:(id)arg2 commentScene:(unsigned long long)arg3;
...
- (_Bool)shouldUseExtendAndScrollConflictResolvingForCommentScene:(unsigned long long)arg1;
- (_Bool)handleConflictForEnableHomePageTransitionContentVMs:(id)arg1 exportIds:(id)arg2 selectedIndex:(id)arg3 navigationController:(id)arg4 tabType:(long long)arg5 commentScene:(unsigned long long)arg6;
...
- (void)appendFinderLiveContentVMs:(id)arg1;
