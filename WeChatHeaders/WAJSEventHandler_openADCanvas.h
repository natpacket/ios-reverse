...
@interface WAJSEventHandler_openADCanvas : WAJSEventHandler_BaseEvent <WCCanvasDynamicDataLoaderDelegate, MMWebViewDelegate, WCCanvasPageViewControllerDelegate>
{
    NSDictionary *_param;
