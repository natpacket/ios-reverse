...
@interface MMImagePreviewBrowserController : WCDragToCloseViewController <WCFinderPostViewControllerDelegate, WCFinderCreateCoordinatorDelegate, EditImageInitialViewDelegate, WCEditImageViewControllerDelegate, EditVideoLogicItemDelegate, WCEditVideoViewControllerDelegate, WCFinderLongVideoChooseHelperDelegate, MMAssetPickerBrowserViewDelegate, MMAssetSelectedCollectionViewDelegate, MultiImageScrollViewDelegate, WCActionSheetDelegate>
{
