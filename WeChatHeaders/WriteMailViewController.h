...
@interface WriteMailViewController : MMUIViewController <MailRTEImageAttachmentViewDelegate, RTEAttachmentViewProviderDelegate, MailRTEToolViewDelegate, UITableViewDelegate, UITableViewDataSource, UITextViewDelegate, WCActionSheetDelegate, UINavigationControllerDelegate, MailContactFilterViewDelegate, MailContentViewDelegate, IQQMailExt, MMMailContactSelectViewDelegate, MailReceiverEditViewDelegate, MailAttachmentControlViewDelegate, VerifyQQPwdMgrExt>
{
