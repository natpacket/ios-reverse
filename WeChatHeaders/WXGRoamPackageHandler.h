...
@class NSRecursiveLock, WXGRoamMsgProducer;

@interface WXGRoamPackageHandler : NSObject
{
    WXGRoamMsgProducer *_msgProducer;
...
@property(retain, nonatomic) WXGRoamMsgProducer *msgProducer; // @synthesize msgProducer=_msgProducer;
