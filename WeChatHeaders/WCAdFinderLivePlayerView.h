...
@class MMFinderLiveFeedPreviewLogic, MMFinderLiveSnsAdStreamInfo, MMLiveCDNPlayerView, MMTimer, NSString, SightIconView, WCAdFinderLiveStreamInfo, WCAdURLImageView, WCDataItem;

@interface WCAdFinderLivePlayerView : MMUIView <MMLiveCDNPlayerViewDelegate>
{
