...
- (id)initWithParam:(id)arg1 appPtr:(unsigned long long)arg2 pageId:(unsigned long long)arg3 callbackId:(long long)arg4 localId:(unsigned int)arg5 isFromView:(_Bool)arg6;
