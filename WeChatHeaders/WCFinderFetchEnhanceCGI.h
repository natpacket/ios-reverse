...
- (void)createRequest;
- (id)initWithLastBuff:(id)arg1 tid:(id)arg2 nonceID:(id)arg3 location:(id)arg4 tabType:(unsigned long long)arg5 readStats:(id)arg6 unreadItems:(id)arg7 viewerScene:(unsigned long long)arg8 clientStatus:(id)arg9 eventType:(unsigned long long)arg10 enhanceStreamType:(int)arg11 successful:(CDUnknownBlockType)arg12 failure:(CDUnknownBlockType)arg13;
