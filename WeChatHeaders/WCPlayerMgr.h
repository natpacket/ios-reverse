...
@interface WCPlayerMgr : MMUserService <SessionFlowSwizzleExt, WCPlayerCoreAdapterDelegate, MMServiceProtocol>
{
    _Bool _bDownloadProxyInitFail;
    int _localServerReinitFailCount;
    unsigned int _taskCount;
    NSMutableDictionary *_dicAggregate;
...
@property(retain, nonatomic) NSMutableDictionary *dicAggregate; // @synthesize dicAggregate=_dicAggregate;
