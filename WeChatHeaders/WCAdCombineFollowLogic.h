...
#import "WCAdHalfScreenCombineFollowViewDelegate-Protocol.h"
...
- (void)parseScene;
- (void)dealloc;
- (id)initWithCombineFollowInfo:(id)arg1 dataItem:(id)arg2 adData:(id)arg3 snsId:(id)arg4 exposureScene:(long long)arg5 source:(int)arg6;
