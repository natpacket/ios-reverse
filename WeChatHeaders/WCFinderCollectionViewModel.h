...
@class FinderCollectionInfo, NSArray, NSMutableArray, NSString, WCFinderCollectionDataFetcher;
@protocol WCFinderCollectionViewModelDelegate;

@interface WCFinderCollectionViewModel : NSObject <WCFinderCollectionDataFetcherExt>
{
    id <WCFinderCollectionViewModelDelegate> _delegate;
...
@property(nonatomic) __weak id <WCFinderCollectionViewModelDelegate> delegate; // @synthesize delegate=_delegate;
...
@property(readonly, nonatomic) NSArray *previousContentVMs;
- (void)dealloc;
