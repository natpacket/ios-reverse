...
#import "WMPFAppTaskAPIProtocol-Protocol.h"

@class MMTimer, NSDictionary, NSMutableArray, NSObject, NSString, WAMemoryPressureRecord, WAThreadSafeMutableDictionary;
