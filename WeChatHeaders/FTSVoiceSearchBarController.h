...
#import "_TtP6WeChat21GlobalSearchDataOwner_-Protocol.h"
#import "contactInfoDelegate-Protocol.h"
#import "contactVerifyLogicDelegate-Protocol.h"

@class AddressBookFriend, CContact, CContactVerifyLogic, ContactInfoViewController, MMUIViewController, NSArray, NSMutableDictionary, NSMutableSet, NSString, PardusSearchRequest_ClickContextInfo, WSWebViewPluginScheduler, _TtC6WeChat22GlobalSearchDataSource, _TtC6WeChat31FTSWebSearchIntentionController;
@protocol FTSResultPage><FTSHomePage;

@interface FTSVoiceSearchBarController : NSObject <ContactInfoViewControllerDelegate, contactVerifyLogicDelegate, contactInfoDelegate, PBMessageObserverDelegate, MFMessageComposeViewControllerDelegate, ContactPickerViewDelegate, WCPayWalletLockVerifyLogicDelegate, IFtsWebSearchExt, IWSSearchUtilExtension, _TtP6WeChat21GlobalSearchDataOwner_, WCActionSheetDelegate, MMUIViewControllerDelegate, UITableViewDelegate, SearchGuideViewDelegate>
{
...
- (void)onClickSearchLocalPageItem:(id)arg1 wordIndex:(long long)arg2 parentScene:(long long)arg3 clickType:(unsigned long long)arg4 needReportClick:(_Bool)arg5;
