...
@interface YTFaceTracker : NSObject <UIAlertViewDelegate>
{
    ...
    CDStruct_c559757e _trackResInfo;
}
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) CDStruct_c559757e trackResInfo; // @synthesize trackResInfo=_trackResInfo;
...
- (CDStruct_c559757e)getTrackInfo;
- (id)getPtsFromFaceShape:(struct TC_FaceShape)arg1 withFacePoints:(void *)arg2;
- (struct CGRect)generateFaceRect:(vector_dc67b4ed)arg1 imageWidth:(int)arg2 imageHeight:(int)arg3;
