...
@class NSString, WCADShareInfo, WCADSphereReportInfo, WCADVideoPlayInfo, WCAdBreakFrameReportInfo, WCAdDynamicFeedReportInfo, WCAdFinderLiveStreamReportInfo, WCAdFinderTopicReportInfo, WCAdFullCardDragImageReportInfo, WCAdFullCardLongPressReportInfo, WCAdSliderCardReportInfo, WCStatTimerHelper;
...
@interface WCADPageWrap : NSObject
{
    ...
    WCAdDynamicFeedReportInfo *_dynamicFeedInfo;
...
@property(retain, nonatomic) WCAdDynamicFeedReportInfo *dynamicFeedInfo; // @synthesize dynamicFeedInfo=_dynamicFeedInfo;
