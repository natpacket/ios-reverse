...
@class CALayer, EVVideoPreviewBrowserView, EditImageCropOverlayView, EditImageDeleteBarView, EditImageWidgetTool, MMTimer, NSArray, NSMutableArray, NSString, UIColor, UIImage, UIPanGestureRecognizer, UITapGestureRecognizer, UIView, WCEditImageScrollView, WCEditPanGestureFilter, WCEditViewControllerUIConfig;
