...
@interface VoiceMessageCellView : CommonMessageCellView <ChatBackgroundExt, IMsgRevokeExt, VoiceTranslateMsgMgrExt, TextFloatPreviewDelegate, IAudioReceiverExt>
{
