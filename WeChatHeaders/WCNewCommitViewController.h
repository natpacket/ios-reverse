...
@class ContactsSelectorController, EmoticonBoardView, ImageSelectorController, MMAsset, MMGrowTextView, MMLoadingView, MMTimer, MMUIButton, MMUILabel, NSArray, NSError, NSString, SightDraft, SightIconView, SightView, UIActivityIndicatorView, UIButton, UIImage, UIImageView, UILabel, UIView, WCCommitPrivacySetting, WCDataItem, WCDragDeleteBarView, WCDragTipView, WCInputController, WCLocationInfo, WCMomentsPostReportSession, WCMomentsTigerTextContainerView, WCMusicInfo, WCPOIStarView, WCPasteTextLengthLogic, WCSelectorView, WCTableViewManager, WCTimelineEnhanceDraftController, WCTimelineExtBean, WCTimelinePOIPickerViewController, WCTimelineTrashReportData;
...
@interface WCNewCommitViewController : MMUIViewController <InputControllerDelegate, BaseEmoticonViewDelegate, WCGroupTagViewControllerDelegate, SightViewDelegate, WCDragableSelectorViewDelegate, WCMomentsPrivacyViewControllerDelegate, WCSightVideoCompositeTaskDelegate, UIScrollViewDelegate, scrollViewDelegate, UITextViewDelegate, SelectorControllerDelegate, MMTableViewInfoDelegate, ContactsSelectorControllerDelegate, IMsgExt, WCFacadeExt, IMMGrowTextViewExt, WCTimelinePOIPickerViewControllerDelegate>
{
    ...
    NSError *_lastSightCompositionError;
    UIView *_repickSightBarView;
    UIImageView *_errorIconView;
    UILabel *_errorTipsLabel;
    UIButton *_errorRepickButton;
...
@property(retain, nonatomic) UIButton *errorRepickButton; // @synthesize errorRepickButton=_errorRepickButton;
...
@property(retain, nonatomic) UIView *repickSightBarView; // @synthesize repickSightBarView=_repickSightBarView;
@property(retain, nonatomic) NSError *lastSightCompositionError; // @synthesize lastSightCompositionError=_lastSightCompositionError;
...
@property(retain, nonatomic) WCMomentsTigerTextContainerView *tigerTextContainerView; // @synthesize tigerTextContainerView=_tigerTextContainerView;
...
- (void)_onClickRepickSightVideoButton:(id)arg1;
- (void)_reloadRepickSightButton;
- (void)_layoutRepickSightBarView;
- (void)_initRepickSightButtonIfNeeded;
- (void)addMediaView;
- (void)createSubviews;
