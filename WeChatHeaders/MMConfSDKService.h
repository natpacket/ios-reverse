...
@interface MMConfSDKService : MMUserService <MMConfSDKVideoHWencDelegate, MMConfSDKVideoHWdecDelegate, MMServiceProtocol, WXCNetWorkDelegate>
{
...
- (void)inviteImp:(id)arg1 token:(id)arg2 inviteCallback:(CDUnknownBlockType)arg3;
...
- (void)dealloc;
- (void)initEngine:(id)arg1 idcInfo:(id)arg2 callback:(CDUnknownBlockType)arg3;
