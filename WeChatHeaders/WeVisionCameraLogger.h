...
#import "XEffectLogAdapterDelegate-Protocol.h"

@class NSString;

@interface WeVisionCameraLogger : MMUserService <XEffectLogAdapterDelegate, WeVisLogAdapterDelegate, MMServiceProtocol>
{
}
