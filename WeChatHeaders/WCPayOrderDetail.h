...
@class NSArray, NSMutableArray, NSString, NoticeItem, RecvAccountInfo, WCPayAddressInfo, WCPayExposureInfo, WCPayOrderDetailActivityInfo, WCPayOrderDetailRemarksInfo, WCPayOrderDetailSubscribeBrandInfo, WCPayOrderDetailTinyAppInfo, WCPayPaidDetailFinderInfoViewData, WCPayPaidDetailLeadTailViewData, WCPayTextInfo, WCPayTransferResendInfo;
