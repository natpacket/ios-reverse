...
@class EmojiInfoObj, EmoticonUploader, NSArray, NSString, TextStateIcon, TextStatePublishBlackListItem, TextStatePublishMediaInfo, TextStatePublishSourceInfo, UIImage, WCLocationInfo;
