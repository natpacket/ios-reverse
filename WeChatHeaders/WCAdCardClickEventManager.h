...
- (_Bool)onClickEventFiredWithActionInfo:(id)arg1 dataItem:(id)arg2 cardType:(long long)arg3 contentItemScene:(unsigned long long)arg4 clickPos:(long long)arg5 clickIndex:(int)arg6 originView:(id)arg7 needReportClick:(_Bool)arg8 customCanvasScene:(int)arg9;
