...
@interface MMWebSearchController : NSObject <UISearchBarDelegate, UIScrollViewDelegate, FTSWebSearchDataSource, WSTagSearchDelegate, WSContactSearchLogicDelegate, WSVideoFlowBaseDelegateExt, WCSearchDelegate, WCDataSearchDelegate, WCMainWindowExt, WSJSEventHandleDelegate>
{
    ...
    unsigned long long _searchContext;
...
- (void)willBeginDetailSearch:(id)arg1 context:(unsigned long long)arg2 andParams:(id)arg3;
...
- (unsigned long long)currentWebSearchContext;
- (void)onBackBtnClick;
- (id)firstPageWebView;
- (id)secondLastResultView;
- (id)currentResultView;
- (_Bool)useTransparentBackground;
