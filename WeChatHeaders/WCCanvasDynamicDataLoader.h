...
+ (_Bool)cacheDynamicXML:(id)arg1 forCanvasLoadParams:(id)arg2;
...
- (void)updateCanvasStateWithCanvasId:(id)arg1 uxinfo:(id)arg2 enterScene:(int)arg3 adExtInfo:(id)arg4 pageId:(id)arg5;
...
- (void)fetchTwistCardStatusWithUxInfo:(id)arg1 canvasScene:(int)arg2 opType:(unsigned int)arg3 cardId:(id)arg4 cardType:(unsigned int)arg5 giveCardId:(id)arg6 canvasId:(id)arg7;
...
- (void)loadDynamicXMLForCanvasLoadParams:(id)arg1;
- (id)getCachedXMLForCanvasLoadParams:(id)arg1;
