...
- (void)finderFeedListViewDoubleLikeAction:(id)arg1 touchPoint:(struct CGPoint)arg2;
- (void)finderFeedListClickToolbarLikeActionWithContentVM:(id)arg1 isPrivateLike:(_Bool)arg2;
- (void)finderFeedListClickFollowBtnActionWithContentVM:(id)arg1;
- (void)finderFeedListClickHeaderMoreAction;
- (void)finderFeedListViewClickNickname:(id)arg1 contentVM:(id)arg2;
- (void)finderFeedListViewClickHeaderView:(id)arg1 contentVM:(id)arg2;
