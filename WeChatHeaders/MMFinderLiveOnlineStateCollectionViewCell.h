...
@class MMCPLabel, MMFinderLiveFansGroupSignView, MMFinderLiveGlobalRankSignView, MMFinderLiveLiveRoleSignView, MMFinderLiveTask, MMFinderLiveUserStateItem, MMLiveHeatAndIconButton, MMUIImageView, MMUILabel, UIView;
