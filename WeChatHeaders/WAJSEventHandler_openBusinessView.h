...
- (void)navigateToMiniProgramWitAppID:(id)arg1 userName:(id)arg2 debugMode:(unsigned long long)arg3 pagePath:(id)arg4 extraData:(id)arg5 privateExtraData:(id)arg6 agentId:(id)arg7 navigationController:(id)arg8 sourceType:(unsigned int)arg9 preScene:(unsigned int)arg10 preSceneNote:(id)arg11 scene:(unsigned int)arg12 sceneNote:(id)arg13 originScene:(unsigned int)arg14 transparentBackgroundEnabled:(_Bool)arg15;
