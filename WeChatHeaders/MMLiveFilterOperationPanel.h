...
@class CAGradientLayer, MMFinderLiveBeautyNewStyleSlider, MMLiveTaskId, MMUIButton, MMUILabel, NSArray, NSString, UICollectionView, UIImageView, UISwipeGestureRecognizer, UITapGestureRecognizer;
