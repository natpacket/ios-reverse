...
@class MMFinderLiveActivityView, MMLiveCDNPlayerView, NSString, RichTextView, UILabel, UIView, WCFinderAuthInfoIconView, WCFinderFeedImageCDNView, WCFinderHeadImageView, WCFinderLiveStreamElementModel;
@protocol WCFinderLiveHomePageRelatedLiveCellDelegate;

@interface WCFinderLiveHomePageRelatedLiveCell : UICollectionViewCell <MMLiveCDNPlayerViewDelegate, ILinkEventExt, WCFinderFeedContentVMExt, WCFinderLiveHomePageCellPlayProtocol>
{
