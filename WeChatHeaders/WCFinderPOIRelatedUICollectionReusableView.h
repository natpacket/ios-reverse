...
+ (double)headerViewHeightWith:(id)arg1 bindContact:(id)arg2 noticeWording:(id)arg3 isDataEmpty:(_Bool)arg4 width:(double)arg5 onlyShowPoiName:(_Bool)arg6 addressSubType:(long long)arg7;
- (void).cxx_destruct;
...
- (void)updateWith:(id)arg1 bindContact:(id)arg2 noticeWording:(id)arg3 isDataEmpty:(_Bool)arg4 onlyShowPoiName:(_Bool)arg5 totalFeedsCount:(long long)arg6 friendLikeCount:(long long)arg7 addressSubType:(long long)arg8;
