...
@interface WXTalkMgr : MMUserService <CNetworkStatusExt, IAUAudioDeviceExt, AUAudioDataSource, IRemoteControlCheckExt, AVAudioPlayerDelegate, MMServiceProtocol, PBMessageObserverDelegate, IWXTalkPresentExt, IContactMgrExt, MMKernelExt>
{
    _Bool _isInTalkRoom;
