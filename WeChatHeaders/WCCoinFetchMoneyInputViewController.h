...
@class KindaUIView, MMTableView, MMUIButton, MMUILabel, NSString, RichTextView, TrueKindaOnePxLineView, UIButton, UIImageView, UILabel, UITextField, UIView, WCPayDecimalKeyboardView, WCPayWebImageView, WecoinTaxCutEntranceInfo;
