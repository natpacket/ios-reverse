...
@interface PSTNMgr : MMUserService <PBMessageObserverDelegate, ISysCallCheckExt, IPSTNSyncExt, AUAudioDataSource, IAUAudioDeviceExt, INetworkStatusMgrExt, MMServiceProtocol>
{
    int mStatus;
