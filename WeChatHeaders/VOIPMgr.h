...
#import "AVVideoDeviceFrameDelegate-Protocol.h"
...
@interface VOIPMgr : MMUserService <PBMessageObserverDelegate, ISysCallCheckExt, AVVideoDeviceDelegate, VoIPAudioServiceExtension, IVOIPSyncExt, AVVideoDataSource, AUAudioDataSource, IAUAudioDeviceExt, INetworkStatusMgrExt, CNetworkStatusExt, CMobileSIMTypeExt, VoIPOrientationServiceExtension, MMServiceProtocol, AVVideoDeviceSessionDelegate, AVVideoDeviceFrameDelegate>
{
    ...
    double _lastRemoteCaptureSleepBeginTimestamp;
    ...
    unsigned long long _remoteFrameIndex;
    ...
    struct CGSize _preferredEncodeSize;
...
@property(nonatomic) unsigned long long remoteFrameIndex; // @synthesize remoteFrameIndex=_remoteFrameIndex;
...
@property(nonatomic) int reportRoomId; // @synthesize reportRoomId=_reportRoomId;
...
@property(nonatomic) double lastRemoteCaptureSleepBeginTimestamp; // @synthesize lastRemoteCaptureSleepBeginTimestamp=_lastRemoteCaptureSleepBeginTimestamp;
...
@property(nonatomic) struct CGSize preferredEncodeSize; // @synthesize preferredEncodeSize=_preferredEncodeSize;
...
- (void)videoDevice:(id)arg1 didParseBufferWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 willParseBufferWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 didProcessBufferByWeVisionWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 willProcessBufferByWeVisionWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 didProcessBufferDefaultWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 willProcessBufferDefaultWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 didDispatchAsyncToSessionQueueWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 willDispatchAsyncToSessionQueueWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 didClipAndRotateBufferWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 willClipAndRotateBufferWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 didSetupWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 willSetupWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 didCompleteToOutputBufferWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 didOutputBufferWithFrameIndex:(unsigned long long)arg2;
- (void)videoDevice:(id)arg1 didDropBufferWithFrameIndex:(unsigned long long)arg2 errorCode:(unsigned long long)arg3;
- (void)videoDevice:(id)arg1 willDropBufferWithFrameIndex:(unsigned long long)arg2;
...
- (void)Ignore:(id)arg1 withRoomId:(unsigned long long)arg2 andKey:(long long)arg3;
...
- (int)GetNicInfo:(void *)arg1 andFrom:(basic_string_0ec669f3)arg2;
- (basic_string_0ec669f3)GetCellularIspInfoStr;
...
- (void)createFrameByHEVCWithBuffer:(char *)arg1 dataType:(int)arg2 dataLength:(int)arg3 frameIndex:(unsigned long long)arg4;
- (void)createFrameByDefaultWithEventCode:(long long)arg1 param:(int)arg2 type:(int)arg3 frameIndex:(unsigned long long)arg4;
