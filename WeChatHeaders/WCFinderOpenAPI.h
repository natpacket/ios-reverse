...
+ (void)getFinderContactWithUsername:(id)arg1 commentScene:(unsigned long long)arg2 successfulBlock:(CDUnknownBlockType)arg3 failedBlock:(CDUnknownBlockType)arg4;
