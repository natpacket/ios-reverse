...
#import "WCMomentsShareScopeSectionFooterDelegate-Protocol.h"

@class NSString, UICollectionView, UILabel, WCMomentsShareScopeBottomView, WCMomentsShareScopeDataSource, WCMomentsShareScopeViewModel;
