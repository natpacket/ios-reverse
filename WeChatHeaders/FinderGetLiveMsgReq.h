...
@class BaseRequest, FinderBaseRequest, FinderGetLiveMsgReportInfo, FinderLiveBattleReportInfo, FinderLiveBoxId, FinderLiveClientStatus, FinderLiveReportBaseInfo, NSData, NSString;
