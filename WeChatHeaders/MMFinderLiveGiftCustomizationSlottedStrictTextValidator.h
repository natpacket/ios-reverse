...
@interface MMFinderLiveGiftCustomizationSlottedStrictTextValidator : NSObject <MMFinderLiveGiftCustomizationTextValidating>
{
...
- (_Bool)isFirstCharacterValid:(id)arg1 reason:(id *)arg2;
