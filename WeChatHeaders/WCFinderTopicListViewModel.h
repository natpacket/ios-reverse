...
- (void)getTopicListWithType:(unsigned long long)arg1 topicTitle:(id)arg2 topicLocation:(id)arg3 latitude:(id)arg4 longitude:(id)arg5 refObjectid:(id)arg6 poiTopicRecommend:(id)arg7 eventTopicId:(unsigned long long)arg8 tabType:(long long)arg9 fromType:(long long)arg10 byPassInfo:(id)arg11;
- (void)loadCacheResponseWithType:(unsigned long long)arg1 topicTitle:(id)arg2 topicLocation:(id)arg3 latitude:(id)arg4 longitude:(id)arg5 refObjectid:(id)arg6 cacheResponse:(id)arg7 cacheDataItems:(id)arg8 sectionInfo:(id)arg9 tabType:(long long)arg10 fromType:(long long)arg11 byPassInfo:(id)arg12;
- (void)dealloc;
- (id)init;
