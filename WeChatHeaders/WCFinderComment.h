...
@class CommentContentInfo, FinderCommentAdvertisementInfo, FinderCommentInfo, FinderContactMsgInfo, NSArray, NSData, NSMutableArray, NSNumber, NSString, WCFinderCommentMentionArray, WCFinderCommentPastedArray, WCFinderContact, WCFinderIpRegionInfo, WCFinderKeywordComponent;
...
@interface WCFinderComment : NSObject <WCTColumnCoding, PBCoding, WCTTableCoding>
{
    ...
    long long _commentEntranceScene;
...
+ (void)__wcdb_table_constraint_43:(void *)arg1;
...
+ (id)commentContentInfoFromListenContentInfo:(id)arg1;
+ (id)contactFromListenUserInfo:(id)arg1;
+ (id)commentFromListenComment:(id)arg1;
...
@property(nonatomic) long long commentEntranceScene; // @synthesize commentEntranceScene=_commentEntranceScene;
...
@property(readonly, nonatomic) FinderCommentAdvertisementInfo *advertisementInfo;
