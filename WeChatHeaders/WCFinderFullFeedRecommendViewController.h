...
@class MMScrollViewProxy, MMUILabel, NSIndexPath, NSMutableDictionary, NSString, PAGView, UIImage, UIImageView, UILabel, UITableView, UITapGestureRecognizer, UIView, UIViewController, WCFinderFeedRecommendVM, WCFinderMsgBubbleMgrPanelView, WCFinderOpenTimelineParams, WCFinderPullDownRefreshHeaderView, WCFinderRefreshTableFooterView, WCFinderScrollActionSheet, WCFinderTLUnreadModel, WCFinderTimelineJumpView, WCFinderTipBarView, WCStoryTouchToDismissView;
@protocol WCFinderCommentBaseViewProtocol, WCFinderFullFeedRecommendViewControllerDelegate;

@interface WCFinderFullFeedRecommendViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource, WCFinderContactExt, WCFinderRefreshTableFooterViewDelegate, EGORefreshTableHeaderDelegate, WCCommitViewResultDelegate, WCFinderRedDotNotifyExt, WCFinderFullMultiMediaTableViewCellDelegate, WCActionSheetDelegate, MMScrollActionSheetDelegate, WCFinderPostingCommentExt, WCFinderCommentDetailViewControllerDelegate, WCFinderRedDotExt, WCFinderFeedRecommendVMDelegate, WCFinderFeedBaseViewControllerProtocol, WCGeneralMonitorDelegate, WCFinderFriendLiveSectionTableViewCellDelegate, WCFinderMsgBubbleMgrPanelViewDelegate, PAGViewListener, WCFinderCardWebViewControllerDelegate, WCCanvasHalfScreenViewControllerDelegate, WCFinderPullDownRefreshHeaderViewStatusDelegate, WCFinderTimelineJumpViewDelegate, RecentForwardScrollViewDelegate, WCFinderPreloadStrategyExt, WCFinderFeedFriendsLikeListViewControllerDelegate, ForwardMessageLogicDelegate, WCFinderTimelineNetworkTipProtocol, MMLiveMorphDismissTarget, RingBackInfoDisplaySheetViewDelegate, WCFinderTLUnreadModelExt, MMSightCameraViewControllerDelegate, WCFinderBulletCommentViewControllerDelegate, WCFinderHalfScreenProtocol, WCFinderTabViewControllerExt, MMFinderLiveCastViewControllerExt, WCFinderTabViewControllerProtocol>
{
...
- (void)feedRecommendScrollToTargetIndexPath:(id)arg1;
...
- (void)onFeedVMReplaceEnhanceList:(id)arg1 targetTid:(id)arg2;
