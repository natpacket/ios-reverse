...
@interface VoipRecentStatusFinderCardView : VoipRecentStatusCardView <RichTextLayoutDelegate, VoipRecentStatusProperties>
{
    ...
    UIView<VoipRecentStatusProperties><VoipRecentStatusFinderBackgroundProtocol> *_backgroundView;
...
@property(retain, nonatomic) UIView<VoipRecentStatusProperties><VoipRecentStatusFinderBackgroundProtocol> *backgroundView; // @synthesize backgroundView=_backgroundView;
