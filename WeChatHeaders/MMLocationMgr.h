...
- (double)longitudeFromAddressDic:(id)arg1;
- (double)latitudeFromAddressDic:(id)arg1;
- (id)poiNameFromAddressDic:(id)arg1;
- (id)poiIdFromAddressDic:(id)arg1;
...
- (id)formattedAddressFromAddressDic:(id)arg1;
...
- (void)requestForAuthorizationFor:(unsigned long long)arg1;
- (void)dealloc;
- (id)init;
