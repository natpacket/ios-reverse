...
#import "MMFinderLiveSpringLotteryEvents-Protocol.h"

@class FinderLiveMilestoneLotteryInfo, FinderLiveMilestoneLotteryMetaInfo, MMFinderLiveTaskId, MMTimer, NSMutableDictionary, NSMutableSet, NSString, WCFinderLiveAudienceLogReporter;
@protocol MMFinderLiveSpringLotteryViewModelDelegate;

@interface MMFinderLiveSpringLotteryViewModel : NSObject <MMFinderLiveSpringLotteryEvents>
{
    _Bool _isAttendingVote;
    unsigned int _ongoingLotteryCountdownSeconds;
    id <MMFinderLiveSpringLotteryViewModelDelegate> _delegate;
...
@property(nonatomic) __weak id <MMFinderLiveSpringLotteryViewModelDelegate> delegate; // @synthesize delegate=_delegate;
- (id)liveTask;
