...
- (void)VoIPTerimation_collectDataAfterClearData;
- (void)VoIPTerimation_collectDataAfterClose;
- (void)VoIPTerimation_collectDataAfterRebootWithType:(unsigned long long)arg1;
