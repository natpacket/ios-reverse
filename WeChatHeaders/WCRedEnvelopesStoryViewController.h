...
@class MMUIButton, NSMutableArray, NSString, UIButton, UIImageView, UILabel, UIPageControl, UIPanGestureRecognizer, UIScrollView, UIView, WCPayWebImageView, WCPayWebPagView, WCRedEnvelopesControlData, WCRedEnvelopesStoryDargUtil, WCRedEnvelopesStoryPageView;
