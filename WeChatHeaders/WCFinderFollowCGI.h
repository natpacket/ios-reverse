...
- (void)createRequest;
- (id)initWithPosterUsername:(id)arg1 finderUsername:(id)arg2 refObjectID:(id)arg3 reportScene:(unsigned long long)arg4 optype:(unsigned long long)arg5 enterType:(unsigned int)arg6 sessionBuffer:(id)arg7 followScene:(unsigned long long)arg8 sessionExtraKey:(id)arg9 successBlock:(CDUnknownBlockType)arg10 failureBlock:(CDUnknownBlockType)arg11;
