...
@interface WAVideoPlayerView : WCPlayerControlView <UIGestureRecognizerDelegate, WMPFVideoAPIProtocol, WAMediaCastingRoutePickerControllerDelegate, WAMediaCastingRoutePickerControllerDataSource, WCAudioModuleDelegate, WAStreamPlayerInterface>
{
