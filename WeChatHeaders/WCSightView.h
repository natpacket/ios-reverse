...
@interface WCSightView : MMUIControl <WCNetworkMediaPlayerDelegate, WCFacadeExt, IUiUtilExt, WCCanvasPageViewControllerDelegate, WCSightFullPlayViewControllerDelegate, UIActionSheetDelegate, WCPlayerDownloaderExt, WCCanvasPageViewControllerExt, WCSNSADPlayerControlViewDelegate, WCPlayerEventExt>
{
