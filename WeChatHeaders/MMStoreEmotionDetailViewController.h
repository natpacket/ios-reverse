...
@class EmojiInfo, EmoticonStoreDetailCoverImageView, EmoticonStoreDetailRewardEntranceView, EmoticonStoreGridView, EmoticonStoreItem, EmoticonStoreReportInfo, EmotionLinkInfo, EmotionRewardResponseInfo, EmotionStoreDetailDesignerContainerView, MMBorderView, MMEmoticonStoreDownloadLogic, MMUIScrollView, MMWebImageView, NSData, NSString, RichTextView, StoreEmotionPageShareLogic, UIButton, UIImageView, UILabel, UIView, WCDataItem;

@interface MMStoreEmotionDetailViewController : MMUIViewController <EmoticonButtonDescExt, IStoreEmotionRewardExt, EmotionStoreDetailRewardEntranceDelegate, EmoticonStoreGridViewDelegate, MMEmoticonStoreDownloadLogicDelegate, EmoticonHalfScreenSendViewDelegate, ILinkEventExt, IEmoticonPackageStateMgrExt, SessionSelectControllerDelegate>
{
    long long _type;
...
- (void)viewDidLoad;
- (id)initWithPid:(id)arg1 Scence:(unsigned long long)arg2 extrance:(long long)arg3 activityToken:(id)arg4;
