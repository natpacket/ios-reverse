...
@class FinderContact, FinderMentionAggregated, FinderMentionContact, FinderMentionExtInfo, FinderMention_FinderMentionThankInfo, FinderMention_LikeContactInfo, FinderNotification, NSString, WCFinderCommentMentionInfo, WCFinderContact, WCFinderMentionAggregatedContactList;
...
- (void)updateWithServerMention:(id)arg1;
