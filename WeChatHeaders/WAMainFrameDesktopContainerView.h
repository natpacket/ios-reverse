...
@interface WAMainFrameDesktopContainerView : UIView <WADesktopStarListReportDelegate, UIGestureRecognizerDelegate, WAMainFrameDesktopWeAppViewControllerDelegate>
{
    UIView *_blurView;
