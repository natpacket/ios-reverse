...
+ (id)swift_hasMusicMVFeeds;
+ (const void *)__wcdb_synthesize_14:(void *)arg1;
+ (const void *)hasMusicMVFeeds;
+ (id)swift_logoutUrl;
...
@property(retain, nonatomic) NSMutableSet *cacheTabs; // @synthesize cacheTabs=_cacheTabs;
