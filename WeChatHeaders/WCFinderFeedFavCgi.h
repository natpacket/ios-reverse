...
- (id)initWithFeedID:(id)arg1 nonceID:(id)arg2 isFav:(_Bool)arg3 sessionBuffer:(id)arg4 scene:(unsigned long long)arg5 sourceType:(int)arg6 completion:(CDUnknownBlockType)arg7 failed:(CDUnknownBlockType)arg8;
