...
#import "JITRuntimeJsApiHandlerDelegate-Protocol.h"
...
@interface WAJSGameService : WAJSCoreService <JITRuntimeDelegate, JITRuntimeDataTransferDelegate, JITRuntimeJsApiHandlerDelegate, WAGameContextDelegate>
{
...
+ (unsigned long long)getFeatBit:(_Bool)arg1;
- (void).cxx_destruct;
