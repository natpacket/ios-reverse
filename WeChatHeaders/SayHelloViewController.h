...
@interface SayHelloViewController : MMUIViewController <SeePeopleNearByUIDelegate, MMTableViewDelegate, UITableViewDelegate, UITableViewDataSource, SayHelloDataLogicDelegate, WCActionSheetDelegate, ContactsItemViewDelegate, VerifyPhoneDelegate>
{
