...
@class FinderClientDraftExtInfo, FinderExtendedReading, FinderFlowCardDesc, FinderFromAppInfo, FinderGeneralReportInfo, FinderLiveDesc, FinderLocation, FinderLongVideoDesc, FinderMVInfo, FinderMediaExtra, FinderMusicInfo, FinderObjectBGMInfo, FinderObjectEventDesc, FinderOriginalDesc, FinderTemplateInfo, FinderTopic, FinderVideoTemplateInfo, NSMutableArray, NSString, OriginalSoundInfo;
