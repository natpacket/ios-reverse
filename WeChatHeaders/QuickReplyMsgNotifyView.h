...
@class ColorGradientView, MMHeadImageView, MMUIButton, MMUILabel, QuickReplyNotifyItem, UIPanGestureRecognizer;
...
@interface QuickReplyMsgNotifyView : UIView
{
    ...
    ColorGradientView *_moreSettingMaskView;
    MMUIButton *_temporaryCloseButton;
    MMUIButton *_closeNotifyTodayButton;
    MMUIButton *_jumpSettingButton;
...
@property(retain, nonatomic) MMUIButton *jumpSettingButton; // @synthesize jumpSettingButton=_jumpSettingButton;
@property(retain, nonatomic) MMUIButton *closeNotifyTodayButton; // @synthesize closeNotifyTodayButton=_closeNotifyTodayButton;
@property(retain, nonatomic) MMUIButton *temporaryCloseButton; // @synthesize temporaryCloseButton=_temporaryCloseButton;
@property(retain, nonatomic) ColorGradientView *moreSettingMaskView; // @synthesize moreSettingMaskView=_moreSettingMaskView;
