...
#import "FavoritePlayerControlViewDelegate-Protocol.h"

@class FavoritePlayerControlView, FavoritesRecordDataField, MMAsset, NSString, UIImageView, WCDownloadArgsWrap, WCPlayerPlayArgs, WCPlayerView;
