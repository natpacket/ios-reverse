...
@optional
- (double)bottomMarginForTabContainerInFinderTabPageView:(WCFinderTabPageView *)arg1;
...
- (double)leftMarginForTabContainerInFinderTabPageView:(WCFinderTabPageView *)arg1;
- (double)heightForGuideAreaViewInFinderTabPageView:(WCFinderTabPageView *)arg1;
- (UIView *)guideAreaInFinderTabPageView:(WCFinderTabPageView *)arg1;
