...
@class NSMutableSet, NSString, WCFinderStreamFooterView;
...
@interface WCFinderProfileProductWindowPage : WCFinderStreamProfileViewPage <UICollectionViewDelegate, UICollectionViewDataSource, WCFinderStreamLayoutDelegate, WCFinderProfileProductWindowViewModelDelegate, WCFinderStreamFooterViewActionDelegate>
{
    ...
    NSMutableSet *_productsHaveReportedExposeIDs;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableSet *productsHaveReportedExposeIDs; // @synthesize productsHaveReportedExposeIDs=_productsHaveReportedExposeIDs;
...
- (id)finderDataItemFromForReport;
- (id)baseProductActionKVReporterParamsForItemAtIndexPath:(id)arg1;
...
- (void)openProductPromotionReplayPage:(id)arg1 replayUrl:(id)arg2;
- (void)showMiniProgramWithProductInfo:(id)arg1 liveDataItem:(id)arg2 shareBlock:(CDUnknownBlockType)arg3;
