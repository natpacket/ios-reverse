...
@property(nonatomic) _Bool withByPass; // @synthesize withByPass=_withByPass;
...
- (id)initWithFromVC:(id)arg1 allContentVMs:(id)arg2 selectIndex:(unsigned long long)arg3 tabType:(long long)arg4 fromNotFinder:(_Bool)arg5 commentScene:(unsigned long long)arg6 entryScene:(unsigned long long)arg7 entryCardType:(unsigned long long)arg8 replayEntryType:(id)arg9 withByPass:(_Bool)arg10 enableScroll:(_Bool)arg11 exportIds:(id)arg12;
- (id)initWithFromVC:(id)arg1 contactVM:(id)arg2 customParams:(id)arg3 tabType:(long long)arg4 fromNotFinder:(_Bool)arg5 commentScene:(unsigned long long)arg6 entryScene:(unsigned long long)arg7 entryCardType:(unsigned long long)arg8;
- (id)init;
- (id)description;
