...
+ (void)setEventCallback:(id)arg1 reportPolicy:(unsigned long long)arg2 callbackBlock:(CDUnknownBlockType)arg3;
+ (void)setObjectEventCallback:(id)arg1 reportPolicy:(unsigned long long)arg2 callbackBlock:(CDUnknownBlockType)arg3;
+ (void)setPageEventCallback:(id)arg1 reportPolicy:(unsigned long long)arg2 callbackBlock:(CDUnknownBlockType)arg3;
+ (void)setViewEventCallback:(id)arg1 reportPolicy:(unsigned long long)arg2 callbackBlock:(CDUnknownBlockType)arg3;
...
+ (CDUnknownBlockType)getDynamicParamsBlock:(id)arg1;
...
+ (void)setObjectReportPolicy:(id)arg1 reportPolicy:(unsigned long long)arg2 routeRule:(unsigned long long)arg3 isRtReport:(_Bool)arg4;
+ (unsigned long long)getViewReportPolicy:(id)arg1;
+ (void)setViewReportPolicy:(id)arg1 reportPolicy:(unsigned long long)arg2 routeRule:(unsigned long long)arg3 isRtReport:(_Bool)arg4;
+ (unsigned long long)getPageReportPolicy:(id)arg1;
+ (void)setPageReportPolicy:(id)arg1 reportPolicy:(unsigned long long)arg2 routeRule:(unsigned long long)arg3 isRtReport:(_Bool)arg4;
