...
- (void)createRequest;
- (id)initWithFinderTaskId:(id)arg1 stockId:(id)arg2 pullScene:(unsigned int)arg3 liveCookies:(id)arg4 lastBuffer:(id)arg5 successBlock:(CDUnknownBlockType)arg6 failBlock:(CDUnknownBlockType)arg7;
