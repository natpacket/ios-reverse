...
#import "MMFinderLiveRewardWishInputViewDelegate-Protocol.h"
#import "MMFinderLiveRewardWishViewDelegate-Protocol.h"
#import "MMLiveHalfScreenTitleBarViewDelegate-Protocol.h"
#import "MMLiveRewardGiftSelectionViewDelegate-Protocol.h"

@class MMFinderLiveRewardWishInputView, MMFinderLiveTask, MMFinderLiveTaskId, MMLiveHalfScreenTitleBarView, MMLiveRewardGiftSelectionView, MMUIButton, MMUILabel, NSArray, NSMutableArray, NSString, UIImageView, UIView;

@interface MMFinderLiveSaveWishListPanel : MMPageSheetBaseView <MMLiveHalfScreenTitleBarViewDelegate, MMFinderLiveRewardWishViewDelegate, MMLiveRewardGiftSelectionViewDelegate, MMFinderLiveRewardWishInputViewDelegate>
{
    _Bool _isModify;
    _Bool _isDeleted;
