...
@class FinderLiveShopCustomerServiceInfo, MMFinderLiveAdsItem, MMFinderLiveGoodsItem, MMFinderLiveLeadsItem, MMFinderLiveShopContext, NSString, OrderedDictionary;

@protocol MMFinderLiveShopShelfViewDelegate <NSObject>

@optional
- (void)onMMFinderLiveOpenReplayButtonClicked:(MMFinderLiveGoodsItem *)arg1 replayUrl:(NSString *)arg2 isFromDetailPage:(_Bool)arg3;
...
- (void)onMMFinderLiveLeadsItemSelected:(MMFinderLiveLeadsItem *)arg1 isActionButtonClick:(_Bool)arg2;
...
- (void)onMMFinderLiveAddToShoppingCartButtonClicked:(MMFinderLiveGoodsItem *)arg1;
- (void)onMMFinderLivePurchaseButtonClicked:(MMFinderLiveGoodsItem *)arg1 shopContext:(MMFinderLiveShopContext *)arg2;
- (void)onMMFinderLiveShopAssistantBtnClickedWithGoodsItem:(MMFinderLiveGoodsItem *)arg1 shopContext:(MMFinderLiveShopContext *)arg2;
...
- (void)onMMFinderLiveShoppingCartButtonClicked:(MMFinderLiveShopContext *)arg1;
