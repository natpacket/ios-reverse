...
@class AdExposureTimerHelper, NSString, WCADSphereReportInfo, WCADVideoPlayInfo, WCAdBreakFrameReportInfo, WCAdDynamicFeedReportInfo, WCAdFinderLiveStreamReportInfo, WCAdFinderTopicReportInfo, WCAdFullCardDragImageReportInfo, WCAdFullCardLongPressReportInfo, WCAdSliderCardReportInfo;
