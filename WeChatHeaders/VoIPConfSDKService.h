...
#import "MMConfSDKVideoHWdecDelegate-Protocol.h"
...
@class ConfAVMemberList, IConfSDKRegisterableCallbackHolder, MMConfSDKAudioMgr, MMConfSDKCGIImp, MMConfSDKMemberMgr, MMConfSDKNativeCallbackMgr, MMConfSDKNetworkMgr, MMConfSDKVideoHWdec, MMConfSDKVideoHWenc, MMContext, MMTimer, NSMutableArray, NSMutableDictionary, NSObject, NSString;
@protocol MultitalkApiDelegate, OS_dispatch_queue, ilinkApiDelegate;

@interface VoIPConfSDKService : MMUserService <MMConfSDKVideoHWencDelegate, MMConfSDKVideoHWdecDelegate, VoIPOrientationServiceExtension, MMServiceProtocol, WXCNetWorkDelegate>
{
...
- (void)RecvNotifyImp:(id)arg1 datalen:(int)arg2 groupId:(id)arg3 sdkGroupId:(id)arg4 displayUserList:(id)arg5 username:(id)arg6;
- (void)recvNotify:(id)arg1 datalen:(int)arg2 groupId:(id)arg3 sdkGroupId:(id)arg4 displayUserList:(id)arg5 username:(id)arg6;
- (void)joinimp:(id)arg1 wxGroupId:(id)arg2 token:(id)arg3;
