...
#import "WCFinderFullScreenEditImageViewControllerDelegate-Protocol.h"
#import "WCFinderFullScreenEditVideoViewControllerDelegate-Protocol.h"
#import "WCFinderMusicSelectViewDataSource-Protocol.h"
#import "WCFinderMusicSelectViewDelegate-Protocol.h"
#import "WCFinderTemplateChooseViewDelegate-Protocol.h"
#import "WCFinderTemplateMusicSelectEntranceViewDelegate-Protocol.h"

@class MMUIButton, NSString, UIImage, UIImageView, UIViewController, WCFinderMusicSelectView, WCFinderTemplateChooseView, WCFinderTemplateMusicSelectEntranceView, WCFinderTemplateProcessVCParams, WCFinderTemplateVideoEditViewModel, WCProgressMaskView;
...
- (void)_updateLoadingProgress:(double)arg1 text:(id)arg2;
- (void)_stopLoadingWithFailText:(id)arg1;
- (void)_stopLoading;
- (void)_startLoadingWithText:(id)arg1;
