...
- (void)createRequest;
- (id)initWithFinderUsername:(id)arg1 micFinderUsername:(id)arg2 micObjectId:(unsigned long long)arg3 micLiveId:(unsigned long long)arg4 cachedGestures:(id)arg5 success:(CDUnknownBlockType)arg6 failure:(CDUnknownBlockType)arg7;
