...
#import "MMFinderLiveFollowNotifyCommentDelegate-Protocol.h"
#import "MMFinderLiveLikeNotifyCommentDelegate-Protocol.h"

@class MMFinderLiveFollowNotifyCommentLogic, MMFinderLiveFollowNotifyDataItem, MMFinderLiveLikeNotifyCommentLogic, MMFinderLiveLikeNotifyDataItem, MMFinderLiveTaskId, MMLiveCommentDataItem, NSMutableArray, NSMutableOrderedSet, NSMutableSet, NSString, PAGFile, PAGView, UITableView, UIView;

@interface MMFinderLiveNotifyCommentLogic : NSObject <MMFinderLiveCommentNotifyExt, MMFinderLiveLikeNotifyCommentDelegate, MMFinderLiveFollowNotifyCommentDelegate>
{
...
- (long long)animationTypeForNextCommentItem:(id)arg1;
