...
#import "WCFinderLiveDiscoveryRelatedLiveCellDelegate-Protocol.h"
#import "WCFinderMoreLiveTagListHeaderViewDelegate-Protocol.h"
#import "WCFinderNearbyMoreLivePageViewModelDelegate-Protocol.h"
#import "WCFinderStreamFooterViewActionDelegate-Protocol.h"

@class MMUIViewController, NSIndexPath, NSMutableArray, NSMutableDictionary, NSString, UIPanGestureRecognizer, WCFinderDataItem, WCFinderFeedFlowView, WCFinderLiveHomePageScrollActionSheet, WCFinderLiveTabInfo, WCFinderMoreLiveExposeStatItem, WCFinderMoreLiveTagListHeaderView, WCFinderNearbyMoreLiveCellPlayModel, WCFinderNearbyMoreLivePageViewModel, WCFinderStreamFooterView;
...
- (void)refreshTop;
- (void)dealloc;
- (id)initWithLiveTabInfo:(id)arg1 view:(id)arg2 InViewController:(id)arg3 fromScene:(unsigned long long)arg4 autoPlayABTestType:(unsigned long long)arg5 byPassInfo:(id)arg6 scene:(unsigned long long)arg7 delegate:(id)arg8;
