...
#import "WCFilterViewDelegate-Protocol.h"
...
@interface WXGDownloadSessionSelectViewController : MMUIViewController <UITableViewDataSource, UITableViewDelegate, WCFilterViewDelegate>
{
    _Bool _isDelete;
