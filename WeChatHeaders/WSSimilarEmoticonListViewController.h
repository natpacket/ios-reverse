...
@interface WSSimilarEmoticonListViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource, MMTableViewDelegate, MMRefreshTableFooterDelegate, WebSearchMgrDelegate, WSSimilarEmotCellDelegate, SharePreConfirmViewDelegate, IStoreEmotionSingleDownloadMgrExt, WCActionSheetDelegate, EmoticonCustomManageAddLogicDelegate, EmoticonCustomAddLogicControllerDelegate>
{
