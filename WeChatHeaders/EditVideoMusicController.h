...
- (id)_audioData;
- (_Bool)_addVideoFrame:(unsigned long long)arg1 classifier:(id)arg2 videoTrack:(id)arg3 error:(id *)arg4;
- (void)_calculateClassifyLabelsWithCompletionHandler:(CDUnknownBlockType)arg1;
