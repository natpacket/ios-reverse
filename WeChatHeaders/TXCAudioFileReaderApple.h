...
{
    struct unique_ptr<liteav::audio::SilkResamplerWrapper, std::__1::default_delete<liteav::audio::SilkResamplerWrapper>> _resampler;
    struct unique_ptr<liteav::audio::AudioFrame, std::__1::default_delete<liteav::audio::AudioFrame>> _inputFrame;
    struct unique_ptr<liteav::audio::AudioFrame, std::__1::default_delete<liteav::audio::AudioFrame>> _outFrame;
...
@property(readonly, nonatomic) struct SilkResamplerWrapper *resampler;
- (id)init;
