...
@class CContact, NSString, RingToneRecommendReporter_23604, RingToneSearchLayout, RingToneVideoSearchViewModel, WCFinderFeedFlowView;

@interface RingToneVideoSearchViewController : WCSearchViewController <WCFinderFeedFlowViewDataSource, WCFinderFeedFlowViewLayoutDelegate, WCFinderFeedFlowViewDelegate, RingToneVideoFeedViewCellDelegate, UITextFieldDelegate>
{
