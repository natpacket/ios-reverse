...
- (void)beginSearchWithHotWordList:(id)arg1 currentHotWord:(id)arg2 objHotwordInfoBuff:(id)arg3 hotWordListBuffer:(id)arg4 forbidenSearchText:(_Bool)arg5 scene:(long long)arg6 reportSeachScene:(unsigned long long)arg7;
...
- (id)initWithSessionId:(id)arg1 inlineSearchScene:(long long)arg2;
- (id)initWithInlineSearchScene:(long long)arg1;
- (id)init;
