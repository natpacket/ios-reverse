...
@class BaseRequest, FinderBaseRequest, FinderClientStatus, FinderLbsTabTipsInfo, FinderLiveBeforeJoinLiveRoomStatus, FinderLiveClientStatus, FinderLiveReportBaseInfo, FinderPressureCtrl, FinderSwitch, NSData, NSMutableArray, NSString;
