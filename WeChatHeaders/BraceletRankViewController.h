...
@class BraceletRankUtils, CAGradientLayer, DeviceRankInfo, ForwardMessageLogicController, MMHeadImageView, MMTableView, MMUILabel, MMWebImageView, NSDictionary, NSMutableArray, NSMutableSet, NSString, NSTimer, UIImage, UIImageView, UILabel, UIView;
