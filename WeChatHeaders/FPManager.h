...
@interface FPManager : MMRootService <PBMessageObserverDelegate, MMKernelExt, MMServiceProtocol>
{
    basic_string_0ec669f3 devToken;
...
- (basic_string_0ec669f3)getDevToken;
- (id)getDevTokenSKBuf;
