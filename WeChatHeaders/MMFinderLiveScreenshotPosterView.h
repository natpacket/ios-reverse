...
#import "MMFinderLiveQrCodeViewBase-Protocol.h"

@class MMFinderLiveScreenshotPosterInfo, MMWebImageView, NSMutableDictionary, NSString, UIImage, UIImageView, UILabel;

@interface MMFinderLiveScreenshotPosterView : UIView <MMFinderLiveQrCodeViewBase>
{
    ...
    MMWebImageView *_qrCodeCenterLogoImageView;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MMWebImageView *qrCodeCenterLogoImageView; // @synthesize qrCodeCenterLogoImageView=_qrCodeCenterLogoImageView;
