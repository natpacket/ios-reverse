...
+ (void)reportScanMultiCodesMarkDotInfoList:(id)arg1 resultOpType:(unsigned int)arg2 selectedIndex:(long long)arg3 tabSessionID:(unsigned int)arg4 scanSessionID:(unsigned int)arg5 clientDetectCostTime:(unsigned long long)arg6 reportScene:(long long)arg7 isCombine:(_Bool)arg8 expoFrom:(unsigned long long)arg9 maskExitType:(unsigned int)arg10;
+ (void)reportScanMultiCodesMarkDotInfoList:(id)arg1 resultOpType:(unsigned int)arg2 selectedIndex:(long long)arg3 tabSessionID:(unsigned int)arg4 scanSessionID:(unsigned int)arg5 clientDetectCostTime:(unsigned long long)arg6 reportScene:(long long)arg7 isCombine:(_Bool)arg8;
