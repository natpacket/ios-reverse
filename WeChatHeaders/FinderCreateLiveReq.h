...
@class BaseRequest, FinderBaseRequest, FinderLiveBulletin, FinderLiveClientStatus, FinderLiveTagInfo, FinderObjectDesc, LiveRoomImg, NSData, NSMutableArray, NSString, PurchaseLivePreviewInfo, WxaGameLiveInfo;
