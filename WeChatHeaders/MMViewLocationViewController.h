...
#import "WCFinderLocationPoiDetailViewDelegate-Protocol.h"

@class AnnotationLogicController, CAGradientLayer, CLLocation, FavDataItemWrap, FavoritesItem, ForwardMessageLogicController, MMFloorPickView, MMMapView, MMScrollActionSheet, MMTimer, NSString, NavigateLogicController, POIInfo, PickLocationAnnotationView, UIButton, UIView, UnderLineLabel, WCFinderLocationPoiDetailViewController;
@protocol ViewLocationDelegate;

@interface MMViewLocationViewController : MMUIViewController <QMapViewDelegate, QMapViewIndoorDelegate, WCActionSheetDelegate, ILocationMgrExt, NavigateLogicControllerDelegate, IFavoritesExt, INavigateLogicControllerExt, FavTagViewDelegate, MMScrollActionSheetDelegate, RecentForwardScrollViewDelegate, ForwardMessageLogicDelegate, WCFinderLocationPoiDetailViewDelegate>
{
    _Bool _canAddToFav;
    ...
    WCFinderLocationPoiDetailViewController *_poiDetailVc;
...
@property(retain, nonatomic) WCFinderLocationPoiDetailViewController *poiDetailVc; // @synthesize poiDetailVc=_poiDetailVc;
