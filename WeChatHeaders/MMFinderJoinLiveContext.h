...
@class FinderBizUserInfo, FinderJoinLiveReq, FinderJoinLiveResp, FinderLiveAdInfo, FinderLiveAnchorFlashSaleConfigInfo, FinderLiveAudienceEventInfo, FinderLiveBackgroundMusicInfo, FinderLiveCheerInfo, FinderLiveConcertRights, FinderLiveFlashSaleInfo, FinderLiveHotCommentAnimationInfoList, FinderLiveInternalPageInfo, FinderLiveMicInfo, FinderLivePackageExtInfo, FinderLivePromoteExtInfo, FinderLivePromoteMsgInfo, FinderLiveRecommendPreloadInfo, FinderLiveResourcePreloadInfo, FinderLiveRewardQuotaSwitchInfo, FinderLiveShopWindowAdItem, FinderLiveUserInfo, FinderLocation, FinderShopCouponInfo, FinderWindowProductInfo, GameLiveRankInfo, GameRankSwitchInfo, LiveRoomImg, LiveSdkInfo, MMFinderLiveConcertInfo, MMFinderLiveFansGroupInfo, MMFinderLiveTaskId, NSArray, NSData, NSString, WCFinderLiveIdentityModel, WCFinderLiveInfo, WCLocationInfo;
...
@property(readonly, nonatomic) _Bool allowPrivateComment; // @synthesize allowPrivateComment=_allowPrivateComment;
...
@property(readonly, nonatomic) _Bool allowPreloadLeadsItems;
...
- (void)updateJoinLiveContextWithRequest:(id)arg1 response:(id)arg2 lastJoinLiveContext:(id)arg3;
