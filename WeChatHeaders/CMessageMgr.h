...
#import "AssetSetResourceExportMgrDelegate-Protocol.h"
...
@class AssetSetDownloadMgr, AssetSetResourceExportMgr, BypSendEmotionMessageMgr, BypSendMessageMgr, CDownloadVideoMgr, CEmoticonDownloadMgr, CEmoticonUploadMgr, CMessageDB, DownloadImageCDNMgr, DownloadImageMgr, DownloadVideoCDNMgr, MMDiskUsageScaner, MessageAssetThreshold, MessagePatternCacheMgr, MultiMediaUploadUnifyMgr, NSDate, NSMutableArray, NSMutableDictionary, NSObject, NSString, OpenDownloadCDNMgr, OpenDownloadMgr, OpenUploadCDNMgr, OpenUploadMgr, OpenUploadVideoCDNMgr, RecordDownloadCDNMgr, RecordUploadCDNMgr, RoomHistoryDownloadCDNMgr, ThumbDownloadMgr, UploadImageCDNMgr, UploadImageMgr, VideoUploadUnifyMgr;
@protocol OS_dispatch_semaphore;

@interface CMessageMgr : MMUserService <IMessageWrapImgExt, MessageWrapImgDelegate, INewSyncExt, PBMessageObserverDelegate, BypSendMessageMgrDelegate, ISendMessageExt, AssetSetResourceExportMgrDelegate, UploadVideoCDNMgrDelegate, MMDiskUsageScannerDelegate, BypSendEmotionMessageMgrDelegate, MMServiceProtocol, IAudioToMessageExt, IVideoExt, IEmoticonExt, MMKernelExt, IMsgExt, UploadImageCDNMgrDelegate, OpenDownloadCDNMgrDelegate, OpenUploadMgrDelegate, OpenUploadCDNMgrDelegate, RecordUploadCDNMgrDelegate>
{
    CMessageDB *m_oMsgDB;
    ...
    AssetSetDownloadMgr *m_oAssetSetDownloadMgr;
    AssetSetResourceExportMgr *m_oAssetsetResourceExportMgr;
    ...
    MMDiskUsageScaner *_diskScanner;
...
@property(retain, nonatomic) MMDiskUsageScaner *diskScanner; // @synthesize diskScanner=_diskScanner;
...
- (void)AddAssetSetMsg:(id)arg1 MsgWrap:(id)arg2 fromResend:(_Bool)arg3;
- (void)AddAssetSetMsg:(id)arg1 MsgWrap:(id)arg2;
...
- (_Bool)isAssetsetUploading:(id)arg1;
...
- (void)onNeedUpdateMsg:(id)arg1 BitSet:(unsigned int)arg2;
- (void)onAssetSetMsgExportFail:(id)arg1;
- (void)onAssetSetMsgExportSucc:(id)arg1;
- (void)ResumeUploadAssetSetMsgWrap:(id)arg1 bAuto:(_Bool)arg2;
- (void)PauseUploadAssetSetMsgWrap:(id)arg1;
- (void)AddAssetSetMsg:(id)arg1 assetSet:(id)arg2;
...
- (void)updateAssetsetStatus:(id)arg1;
