...
@class NSString, TingAppNavigationController, TingAppViewController, UIViewController;
@protocol ITingApp;

@interface TingNativeRouter : NSObject <ITingRouter>
{
    TingAppNavigationController *_appContainer;
    TingAppViewController *_appViewController;
}

+ (void)tryAddTingItemToList:(id)arg1;
+ (id)pageFromCategory:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) TingAppViewController *appViewController; // @synthesize appViewController=_appViewController;
