...
@class FinderEventInfo, FinderMusicTopicInfo, FinderTopicBgmInfo, NSData, NSMutableArray, NSString, WCFinderEventTabInfo, WCFinderMusicTopicDataProvider, WCFinderTopicInfo;
...
- (void)dealloc;
- (id)initWithTopicParams:(id)arg1 eventTabInfo:(id)arg2 commentScene:(unsigned long long)arg3 byPassInfo:(id)arg4 musicInfo:(id)arg5;
