...
@interface MMScrollActionSheet : UIView <MMScrollActionSheetItemViewDelegate, IUiUtilExt, MMSceneDelegateExt, UIScrollViewDelegate, UIPopoverPresentationControllerDelegate, MMActionSheetScrollViewDelegate, IWCRichTextLabelDelegate, MMScrollActionSheetContainerViewDelegate>
{
    _Bool _moveRight;
