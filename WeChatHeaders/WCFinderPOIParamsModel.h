...
- (id)initWithFinderPOIRelatedWithPOIInfo:(id)arg1 poiClassifyId:(id)arg2 fromObjectId:(unsigned long long)arg3 reportID:(id)arg4 entryScene:(unsigned long long)arg5;
