...
+ (id)searchFromContacts:(id)arg1 allContact:(id)arg2 dicAddressBook:(id)arg3 dicCheckList:(id)arg4 dicMatchTip:(id)arg5 helpDataItem:(id)arg6 isNotSearchChatRoomMember:(_Bool)arg7;
