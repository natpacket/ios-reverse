...
@interface FavoritePlayerControlView : WCPlayerControlView <SightIconViewDelegate, VideoProgressBarDelegate, UIGestureRecognizerDelegate, RawVideoDownloadMgrExt>
{
    _Bool _isRawVideo;
