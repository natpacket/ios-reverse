...
@interface WCAddressInfoViewController : WCAddressBaseViewController <CNContactPickerDelegate, MMPickLocationViewControllerDelegate, WCAddressHalfScreenDelegate>
{
