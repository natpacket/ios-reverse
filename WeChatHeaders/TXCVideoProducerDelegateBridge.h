...
#import "TXCCustomVideoProcessDelegate-Protocol.h"
#import "TXCCustomVideoRendererDelegate-Protocol.h"
#import "TXIVideoProducerDelegate-Protocol.h"

@class NSString;

@interface TXCVideoProducerDelegateBridge : NSObject <TXIVideoProducerDelegate, TXCCustomVideoRendererDelegate, TXCCustomVideoProcessDelegate>
{
    void *_producer;
    struct Lock _lock;
