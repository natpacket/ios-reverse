...
@class CaptureVideoInfo, EditImageAttr, EditVideoAttr, ImageInfo, MMAsset, NSArray, NSData, NSString, SightDraft, UIImage, UIViewController;
...
- (void)processInsertedAssetSet:(NSArray *)arg1 sessionID:(NSString *)arg2;
