...
@class FinderLiveAliasInfo, FinderStreamPrefechTimeIntervalConf, NSArray, NSDictionary, NSMutableArray, NSString, WCFinderTLStreamPreloadInfo, WCFinderTipsShowEntranceExtInfo, WCFinderUserMentionModel;
...
@interface WCFinderSetting : NSObject <PBCoding>
{
    ...
    _Bool _shouldShowFinderRemindSwitch;
    ...
    WCFinderTLStreamPreloadInfo *_preloadInfo;
...
@property(nonatomic) _Bool shouldShowFinderRemindSwitch; // @synthesize shouldShowFinderRemindSwitch=_shouldShowFinderRemindSwitch;
...
@property(retain, nonatomic) WCFinderTLStreamPreloadInfo *preloadInfo; // @synthesize preloadInfo=_preloadInfo;
