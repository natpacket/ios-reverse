...
@interface CExtendInfoOfAPP : NSObject <IMessageWrapExt, IMsgExtendOperation, NSCopying>
{
    ...
    AssetsetMsgExtInfo *m_oAssetsetExtInfo;
...
@property(retain, nonatomic) AssetsetMsgExtInfo *m_oAssetsetExtInfo; // @synthesize m_oAssetsetExtInfo;
