...
@class FinderJumpInfo, FinderLiveAppMsgLiveRewardInfo, FinderLivePromoteInfoListMpArticleInfo, FinderLiveShopWindowAdItem, FinderWindowProductInfo, MMFinderLiveAdsItem, MMFinderLiveBannerInfo, MMFinderLiveConnectMicUser, MMFinderLiveCouponView, MMFinderLiveGameTeamWAGameJumpInfo, MMFinderLiveGoodsItem, MMFinderLiveLeadsItem, MMFinderLiveMusicDataItem, MMFinderLiveOperationView, MMFinderLiveRewardGiftItem, MMFinderLiveScreenshotPosterLogic, MMFinderLiveWebPageSheetParams, MMFinderLiveWinterOlympicOperationView, MMLiveCameraOperationPageSheet, NSArray, NSDictionary, NSNumber, NSString, UINavigationController;
...
- (void)onMMLiveOperationPubbleTipLeadsItemActionClick:(MMFinderLiveLeadsItem *)arg1 isActionButtonClick:(_Bool)arg2;
...
- (void)onMMLiveOperationJumpToAdFromBannerWithBannerInfo:(MMFinderLiveBannerInfo *)arg1;
...
- (void)onMMLiveOperationLiveGoodsTipViewPurchaseBtnClickedForAudience:(FinderWindowProductInfo *)arg1;
