...
+ (void)ReportEmoticonAction:(unsigned long long)arg1 emoticonWrap:(id)arg2 newScene:(long long)arg3 sessionID:(id)arg4 fromUsr:(id)arg5;
+ (void)ReportEmoticonAction:(unsigned long long)arg1 md5:(id)arg2 scene:(unsigned long long)arg3 designerId:(id)arg4 productId:(id)arg5 userName:(id)arg6 newSceneStr:(id)arg7 searchId:(id)arg8 docId:(id)arg9 activityId:(id)arg10 sessionID:(id)arg11;
