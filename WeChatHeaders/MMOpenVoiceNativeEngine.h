...
+ (int)joinRoom:(long long)arg1 roomType:(int)arg2 networkType:(int)arg3 muteAudio:(_Bool)arg4;
+ (int)updateSessionKey:(id)arg1;
+ (id)generateInitInfo:(id)arg1 subAppId:(id)arg2 sessionKey:(id)arg3 audioType:(int)arg4 maxWidth:(int)arg5 maxHeight:(int)arg6 forceCellularNetwork:(_Bool)arg7;
+ (int)GetCPUCapacity;
+ (int)initEngine:(id)arg1 subAppId:(id)arg2 sessionKey:(id)arg3 audioType:(int)arg4 maxWidth:(int)arg5 maxHeight:(int)arg6 forceCellularNetwork:(_Bool)arg7 nCallback:(struct IWXConfCallback *)arg8;
