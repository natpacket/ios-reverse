...
@class BrandProfileEnterInfo, CBaseContactInfoAssist, CContact, CContactVerifyLogic, CMessageWrap, ForwardMessageLogicController, MMPageSheetAdapter, MMTimer, MMUIButton, MMUIView, NSData, NSDictionary, NSMutableDictionary, NSString, SendVerifyMsgLogicController, TextStateProfileCardContentView, TextStateProfileDragAnimateHelper, UIButton, UITableView, WCStoryDragAnimationUtil;
