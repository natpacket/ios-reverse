...
- (void)bindSafeCheckPanelSubviewClickReportCommentScene:(unsigned long long)arg1 showType:(unsigned long long)arg2;
- (void)bindSafeCheckPanelExposeReportCommentScene:(unsigned long long)arg1 showType:(unsigned long long)arg2;
