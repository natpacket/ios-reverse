...
@interface BraceletBlackListViewController : MMUIViewController <MultiSelectContactsViewControllerDelegate, NewChatRoomMemberItemViewDelegate, MMTableViewDelegate, IContactMgrExt, UITableViewDataSource, UITableViewDelegate>
{
    _Bool _deleteStatus;
