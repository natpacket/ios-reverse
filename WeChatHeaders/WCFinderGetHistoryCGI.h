...
- (void)start;
- (id)initWithLastBuff:(id)arg1 clientStatus:(id)arg2 username:(id)arg3 tabType:(long long)arg4 commentscene:(unsigned long long)arg5 fluencyReportSceneKey:(id)arg6 successful:(CDUnknownBlockType)arg7 failure:(CDUnknownBlockType)arg8;
