...
@interface PreEnterShowGlobalAlertStep : PreEnterBaseStep <WCAccountBindPhoneControlLogicDelegate, PasswordLogicDelegate, WCAccountSetPasswordViewControllerDelegate, settingModifyEmailDelegate, IUiUtilExt>
{
