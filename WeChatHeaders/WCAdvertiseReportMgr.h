...
+ (void)reportCombineFollow:(id)arg1 snsId:(id)arg2 source:(int)arg3 brandUsername:(id)arg4 brandOpenType:(int)arg5 brandResult:(int)arg6 finderUsername:(id)arg7 finderResult:(int)arg8;
...
+ (void)reportConversionOnline:(int)arg1 ext:(id)arg2 biz:(id)arg3;
...
+ (void)reportQuicklyAddBrandResult:(id)arg1 snsid:(id)arg2 enterType:(int)arg3 result:(int)arg4 brandUsername:(id)arg5;
+ (void)reportQuicklyAddBrandHalfScreenBtnClick:(id)arg1 snsid:(id)arg2 reportType:(int)arg3 brandUsername:(id)arg4;
