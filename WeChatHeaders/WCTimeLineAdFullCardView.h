...
#import "WCAdBreakFrameViewDelegate-Protocol.h"
#import "WCAdDraggableImageViewDelegate-Protocol.h"
#import "WCSightViewDelegate-Protocol.h"

@class CAShapeLayer, NSArray, NSMutableArray, NSString, UIBezierPath, UIButton, UIColor, UILongPressGestureRecognizer, UIPanGestureRecognizer, WCAdDraggableImageView, WCAdFinderLiveLogic, WCAdFinderLivePlayerView, WCAdFullCardContentContainerView, WCAdFullCardDragImageGestureInfo, WCAdInteractionLabelLogic, WCAdLiveDisplayView, WCAdLiveLikeAnimationView, WCGestureReportInfo, WCGestureSet, WCTimeLineAdFullCardSightView;
